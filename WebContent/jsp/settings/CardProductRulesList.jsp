...
<body bgcolor="ffffff">
 <html:form  action ="cardproductruleslist.do">
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardproductrules.screentitle"/> </td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="cardproductrules.cardproductname"/></td>
   ...
   <display:caption><font class="titreSection">Card Product Rules Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="cardproductrulesprocess.do">	 
