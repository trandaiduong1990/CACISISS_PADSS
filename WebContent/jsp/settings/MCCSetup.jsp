...
<html:html>
<head>
<title><bean:message key ="mccsetup.screentitle"/></title>
...
<script language="JavaScript">
   function go(action) {
    ...
    function showList(){
          document.forms[0].action= "mcclist.do?method=List";
          document.forms[0].submit();
       }
...
<body bgcolor="ffffff">
   <html:form action="mccprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="504"><bean:message key ="mccsetup.screentitle"/></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td class="form_tab_on" background="images/form_tab_bg_on.gif" style="padding-left:15px"> 
                         <bean:message key ="mccsetup.mcc"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="padding: 20px 20px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><bean:message key ="mccsetup.mcc"/></td>
                          <td>
                          	<logic:present scope="request" name="ACTION">
	                          	<logic:equal name="ACTION" value="change">
	                          		<html:hidden property="merchantId" name="mccSetupForm" />
	                          		<bean:write name="mccSetupForm" property="merchantId"/> 
	                          	</logic:equal>
	                          	...
	                          	<logic:equal name="ACTION" value="add">
	                          		<html:text property="merchantId" maxlength="4" size="10"/>
	                          	</logic:equal>
	                          </logic:present>
	                          <logic:present scope="request" name="ACTION">
                        ...
                        <tr>
                          <td class="desc_cell" nowrap><bean:message key ="mccsetup.description"/></td>
                          <td ><html:text property="merchantType"  maxlength="30" size="35" /></td>
                        </tr>
                         <tr>
                          <td class="desc_cell" nowrap><bean:message key ="mccsetup.floorlimit"/></td>
                          <td ><html:text property="floorLimit"  maxlength="10" size="20"/></td>
                        </tr>
                         <tr>
                          <td class="desc_cell" nowrap><bean:message key ="mccsetup.currencycode"/></td>
