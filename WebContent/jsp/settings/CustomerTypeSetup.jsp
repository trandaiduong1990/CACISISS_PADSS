...
<script language="JavaScript">
   ...
   /// function addNew() {
      /// document.forms[0].action="customertypesetup.do";
      /// document.forms[0].submit();
   /// }
    function showList(){
          document.forms[0].action= "customertypelist.do?method=List";
          document.forms[0].submit();
       }  
</script>
...
<body bgcolor="ffffff">
<html:form action="customertypeprocess.do">
                ...
                <tr>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="customertypesetup.customertypeid"/> * </b></td>
                                <td>
                                <logic:present scope="request" name="ACTION">
					                    <logic:equal name="ACTION" value="change">
					                    		<html:hidden property="customerTypeId" name="customerTypeSetupForm" />
							      	   			<bean:write name="customerTypeSetupForm" property="customerTypeId"/>
					                    </logic:equal>
					                    ...
					                    <logic:equal name="ACTION" value="add">
	                                			<html:text property="customerTypeId" maxlength ="6" size="10" />
					                    </logic:equal>
				                    </logic:present>
				                    <logic:present scope="request" name="ACTION">
                              ...
                              <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="customertypesetup.customertype"/> * </b></td>
                                <td><html:text property="customerType" maxlength="20" size="25"/>                                </td>
                              </tr>
                              <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="customertypesetup.status"/> * </b></td>
                                <td valign="top">
