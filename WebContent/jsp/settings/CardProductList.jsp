...
<html:html>
<head>
<title><bean:message key ="cardproductsearch.screentitile"/></title>
...
<script language="JavaScript">
    ...
    function addNew() {
       ...
       document.forms[0].action="cardproductprocess.do?method=addNew";
...
<body bgcolor="ffffff">
 ...
 <html:form  action ="cardproductlist">
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardproductsearch.screentitile"/></td>
        </tr>
        <tr>
  ...
  <tr>
   ...
   <display:column property="column1" title="Card ProductId" class="label" />
   ...
   <display:caption><font class="titreSection">Card Product Setup Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="cardproductprocess.do">	 
