...
<html:html>
<head>
<title><bean:message key ="billingcyclesetup.screentitle"/></title>
...
<script language="JavaScript">
   function go(action) {
    ...
    function showList(){
          document.forms[0].action= "cyclelist.do?method=List";
          document.forms[0].submit();
       }
...
<body bgcolor="ffffff">
  <html:form action="cycleprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="504"><bean:message key ="billingcyclesetup.screentitle"/></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td class="form_tab_on" background="images/form_tab_bg_on.gif" style="padding-left:15px"> 
                         <bean:message key ="billingcyclesetup.group1"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="padding: 20px 20px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="billingcyclesetup.cycleno"/> * </b></td>
                          <td>
                          <logic:present scope="request" name="ACTION">
	                          	<logic:equal name="ACTION" value="change">
	                          		<html:hidden property="cycleNo" name="cycleSetupForm" />
	                          		<bean:write name="cycleSetupForm" property="cycleNo"/> 
	                          	</logic:equal>
	                          	...
	                          	<logic:equal name="ACTION" value="add">
	                          		<html:text property="cycleNo"  maxlength="1" size="10" />
	                          	</logic:equal>
	                          </logic:present>
	                          <logic:present scope="request" name="ACTION">
                        ...
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="billingcyclesetup.dayofmonth"/> * </b></td>
                          <td ><html:text property="dayOfMonth" maxlength="2" size="10"/></td>
                        </tr>
                       </table></td>
                      </tr>
