...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action= "cardtypeprocess.do?method=addNew";
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardtypesearch.screentitle"/> </td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="cardtypesetupsearch.cardtype"/></td>
                        <td> <html:select property="cardTypeId">
   ...
   <display:column property="column1" title="Card Type Id" class="label" />
   <display:column property="column2" title="Card Type" class="label" />
    <display:column property="column3" title="Updated Date" class="label" />
   <display:caption><font class="titreSection">CardType Setup Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="cardtypeprocess.do">	 
	
              <html:hidden property="cardTypeId" value="<%= ((CommonDataBean)pageContext.getAttribute("commonObj")).getColumn1()%>" />
