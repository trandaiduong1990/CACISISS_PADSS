...
<html:html>
<head>
<title><bean:message key ="cardbatcprocess.newproductcards.screentitle"/></title>
    ...
    function batchProcess(method) {
        //alert('test');
          //document.forms[0].method.value=method;
	   	  ...
	   	  if (r==true)
	   	  {
	   	    document.forms[0].action="newcardproductbatchprocess.do?method=process";
	   		document.forms[0].submit();
	   	  }
      }

    function go(param) {
        document.forms[0].action="newcardproductbatchprocess.do?method=List";
...
<html:form action ="newcardproductbatchprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardbatcprocess.newproductcards.screentitle"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="titreSection">
              ...
              <tr> 
                ...
                <logic:present name="newProductCardBatchprocessFrom" property="appList"> 
					<bean:size id="size" name="newProductCardBatchprocessFrom" property="appList"/>
      ...
      <table width="100%">
          ...
          <td valign="top">
          	<table>
          		...
          		<tr>
          			...
          			<td>
          				<bean:write name ="newProductCardBatchprocessFrom" property="totalNoOfApps" />
          			</td>
          		</tr>
          	</table>
          </td>
        ...
        <tr> 
          <td valign="top">
			   ...
			   <display:table  id="appProcess" name="newProductCardBatchprocessFrom" property="appList" class="simple" width="80%">
				   <display:column property="column1" title="Sequense Id" class="label" />
				   ...
				   <display:caption><font class="titreSection">New Product Cards Batch Process Records</font></display:caption>
			   </display:table>
     	  </td>
        </tr>
  		<tr> 
                  ...
                  <tr>
                   ...
                   <tr>
                    <td>
						...
						<tr>
	                         <td nowrap class="desc_cell" style="width: 80px;">
