...
<body bgcolor="ffffff">
<html:form action ="newcardbatchprocess">
...
<bean:define id="cardNums" name="newCardBatchprocessFrom" property="cardNos"/>
<bean:define id="authPerson" name="newCardBatchprocessFrom" property="authUserId"/>
    ...
    <td valign="top">
     <br>
      <table width="100%">
          ...
          <td valign="top">
          	<table>
          		...
          		<tr>
          			...
          			<td>
						<bean:size id="size" name="newCardBatchprocessFrom" property="successAppsPrimaryList"/>
        ...
        <tr> 
          <td valign="top">
			<logic:present name="newCardBatchprocessFrom" property="successAppsPrimaryList"> 
			<bean:size id="size2" name="newCardBatchprocessFrom" property="successAppsPrimaryList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="appProcess" name="newCardBatchprocessFrom" property="successAppsPrimaryList" class="simple" width="80%">
        ...
        <tr> 
          <td valign="top">
			<logic:present name="newCardBatchprocessFrom" property="successAppsSuppList"> 
			<bean:size id="size1" name="newCardBatchprocessFrom" property="successAppsSuppList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="appProcess" name="newCardBatchprocessFrom" property="successAppsSuppList" class="simple" width="80%">
				   <display:column property="applicationId" title="Application Id" class="label" />
				   <display:column property="customerName" title="Customer Name" class="label" />
				   <display:column property="idNumber" title="NRIC" class="label" />
				   <display:column property="cardNumber" title="Card No" class="label" />
