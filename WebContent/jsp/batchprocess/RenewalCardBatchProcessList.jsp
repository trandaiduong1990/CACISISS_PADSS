...
<script language="JavaScript">
    ...
    function batchProcess() {
    	var r=confirm("<bean:message key ='areyousure'/>");
    	  if (r==true)
    	  {
    	    document.forms[0].action="renewalcardbatchprocess.do?method=process";
    		document.forms[0].submit();
    	  }
      }

    function go(param) {
        document.forms[0].action="renewalcardbatchprocess.do?method=List";
        ...
        <tr>
          <td class="titreSection">
              ...
              <tr> 
                ...
                <logic:present name="renewalCardBatchprocessFrom" property="appList"> 
					<bean:size id="size" name="renewalCardBatchprocessFrom" property="appList"/>
      ...
      <table width="100%">
          ...
          <td valign="top">
          	<table>
          		...
          		<tr>
          			...
          			<td>
          				<bean:write name ="renewalCardBatchprocessFrom" property="totalNoOfApps" />
          			</td>
          		</tr>
          	</table>
          </td>
        ...
        <tr> 
          <td valign="top">
			   ...
			   <display:table  id="appProcess" name="renewalCardBatchprocessFrom" property="appList" class="simple" width="80%">
				   ...
				   <display:column property="column3" title="Expire Date" class="label" />
				   <display:column property="column4" title="Applied Date" class="label" />
				   <display:caption><font class="titreSection">Renewal Cards Batch Process Records</font></display:caption>
			   </display:table>
     	  </td>
        </tr>
  		<tr> 
                   ...
                   <tr>
                    <td>
						...
						<tr>
	                         ...
	                         <td>
	                         	<html:password property="authPassword" />
	                         </td>
						</tr>
						</table>
					</td>	
