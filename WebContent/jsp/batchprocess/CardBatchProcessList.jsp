...
<html:html>
   ...
   <body bgcolor="ffffff">
      <html:form action="searchcardbatchprocessaction">
      ...
      <div style="padding-top: 5px;"><b><bean:write name="cardBatchSearchForm"
         property="total" /></b>
      ...
      <form name="listForm"
         action="cardbatchprocessdispatchaction.do"><html:hidden
         property="id"
      ...
      <html:hidden property="issuerId"
         ...
         property="screenType" value="list" /> <%
