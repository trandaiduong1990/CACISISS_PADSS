...
<script language="JavaScript">
    ...
    function batchProcess() {
    	  ...
    	  if (r==true)
    	  {
    	    document.forms[0].action="supplementarycardbatchprocess.do?method=process";
    		document.forms[0].submit();
    	  }
      }

    function go(param) {
        document.forms[0].action="supplementarycardbatchprocess.do?method=List";
        ...
        <tr>
          <td class="titreSection">
              ...
              <tr> 
                ...
                <logic:present name="supplementaryCardBatchprocessFrom" property="appList"> 
					<bean:size id="size" name="supplementaryCardBatchprocessFrom" property="appList"/>
      ...
      <table width="100%">
          ...
          <td valign="top">
          	<table>
          		...
          		<tr>
          			...
          			<td>
          				<bean:write name ="supplementaryCardBatchprocessFrom" property="totalNoOfApps" />
          			</td>
          		</tr>
          	</table>
          </td>
        ...
        <tr> 
          <td valign="top">
			   ...
			   <display:table  id="appProcess" name="supplementaryCardBatchprocessFrom" property="appList" class="simple" width="80%">
				   ...
				   <display:column property="column3" title="Principal Card Number" class="label" />
				   <display:column property="column4" title="Reason" class="label" />
				   <display:column property="column5" title="Applied Date" class="label" />
				   <display:caption><font class="titreSection">Supplementary Cards Batch Process Records</font></display:caption>
			   </display:table>
     	  </td>
        </tr>
  		<tr> 
