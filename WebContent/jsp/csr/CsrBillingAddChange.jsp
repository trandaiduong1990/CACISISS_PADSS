...
<%@ page import ="org.transinfo.cacis.formbean.customerservice.CardReplacementForm" %>
...
<html:form action="billingaddChange.do">
  <input type="hidden" name="method"/>
   <html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
      <html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>
     <logic:present name ="cardReplacementForm" scope="request">
         <html:hidden property="customerId" value="<%=((CardReplacementForm)request.getAttribute("cardReplacementForm")).getCustomerId()%>"/>
     </logic:present>
          ...
          <tr> 
            <td valign="top" height="323"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.currentaddress"/> </td>
                        ...
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                           <tr>
                            ...
                            <tr>
                              ...
                              <td height="2" class="label"><bean:write name ="cardReplacementForm"  property="requestAddress.state"/></td>
                            </tr>
                            <tr>
                              <td nowrap class="desc_cell"><bean:message key ="customerrelation.country"/></td>
                              <td class="label"> <html:select  property = "requestAddress.country" name = "cardReplacementForm" disabled="true">
                    ...
                    <tbody>
                      <tr>
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.newaddress"/></td>
                                <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                              </tr>
                            </tbody>
                        </table></td>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                            ...
                            <tr>
                              <td class="desc_cell" nowrap><bean:message key ="customerrelation.city"/></td>
                              <td class="label"><html:text   property="requestAddress.city" size="20" value=""/></td>
                            </tr>
                            <tr>
                              <td class="desc_cell" nowrap height="2"><bean:message key ="customerrelation.state"/></td>
                              <td height="2" class="label"><html:text  property="requestAddress.state" size="20" value=""/></td>
                            </tr>
                            <tr>
                              <td nowrap class="desc_cell"><bean:message key ="customerrelation.country"/></td>
                              <td class="label"> <html:select  property = "requestAddress.country" name = "cardReplacementForm" >
                               <html:option value="">SelectCountry</html:option>
                               <logic:greaterThan name = "cardReplacementForm"  property="countryList" value="0" >
							     	 <html:optionsCollection name = "cardReplacementForm" property="countryList" value="key" label="value" /> 
							  	 </logic:greaterThan>	
				...
				<tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('billingaddchange')" > <bean:message key ="common.change"/></html:button></td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
