...
<body bgcolor="ffffff">
<html:form action="csrcardreceived.do">
          ...
          <tr> 
            <td valign="top" height="323"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                    ...
                    <tbody>   <font color="#FF0000"> <html:errors/> </font>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.cardreceived"/></td>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="100" height="70">
                             <tr> 
		                    <td class="desc_cell"><bean:message key ="customerrelation.remarks"/></td>
		                    <td  class="label"> <html:text  property="remarks" onkeypress="return disableEnterKey(event)" /> </td>
		                    </tr>
                        </table></td>
                      </tr>
                    </tbody>
                ...
                <tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('cardreceived')"><bean:message key ="common.confirm"/></html:button></td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
