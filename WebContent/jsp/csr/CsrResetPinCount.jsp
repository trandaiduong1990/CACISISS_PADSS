...
<html:form action="csrresetpincount.do">
                ...
                <tr> 
                  ...
                  <td colspan="2" valign="top" class="form_bgcolor" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                    ...
                    <tbody>   <font color="#FF0000"> <html:errors/> </font>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.wrongpinreset"/></td>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="150" height="40">
             <logic:present name="PINCOUNT">         
                  <logic:iterate id ="commonObj" name ="PINCOUNT">
                            <tr>
                              <td class="desc_cell"><bean:message key ="customerrelation.resetpincount"/>  </td>
                ...
                <tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('resetpincount')" > <bean:message key ="common.resetpincount"/></html:button></td> 
                  <td background="images/tbl_d.gif"></td>
                </tr>
