...
<html:html>
<head>
<title><bean:message key ="customerservice.aascreentitle"/></title>
...
function go(method) 
{
  ...
  if(method == "change"){
    //var tag =confirm("Do you want to proceed with the Account Adjustment..??");
	    if(!confirm("Do you want to proceed with the Account Adjustment..??"))
	    	return false; 
  }
...
<body bgcolor="ffffff">
<html:form  action ="accountadjustmentpage" >
<input type ="hidden" name ="method" />

 <!-- this for showing the search condition-->
 <logic:notPresent name="$ACCOUNTADJUSTMENT$"> 
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.aascreentitle"/></td>
        </tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr> 
                        <td> <font class="label"><b><bean:message key ="customerservice.aacardno"/></b></font> 
...
<logic:present name="$ACCOUNTADJUSTMENT$">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.aascreentitle"/></td>
              ...
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="customerservice.accountadjustment"/>                    </td>
                        <td><img src="images/form_tab_btw_on_off.gif" width="25" height="22"></td>
                        <td background="images/form_tab_bg_off.gif" class="form_tab_off"><a href="javascript:viewAllInfo('csrprocess.do?method=csrSummary&CustServCardNo=<bean:write name ="accountAdjustmentForm"  property="cardNo" />')"><bean:message key ="customerservice.viewtotalinformation"/></a></td>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
        		    ...
        		    <%} %>
        		    <html:button property="submitbutton" onclick="showList('accountadjustmentpage.do?method=checkSession')"><bean:message key ="common.cancel"/></html:button>
                    </div>
                  </td>
                      ...
                      <tr>
                        <td height="21">
                        	<table border="0" cellpadding="0" cellspacing="0" width="264">
                         	<tr> 
                              <td class="desc_cell" nowrap  height="18" ><bean:message key ="customerservice.accountcardlimit"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="cardLimit" /></td>
                            </tr>
                         	<tr> 
                              <td class="desc_cell" nowrap  height="18" ><bean:message key ="customerservice.limitused"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="limitUsed" /></td>
                            </tr>
                         	<tr> 
                              <td class="desc_cell" nowrap  height="18" ><bean:message key ="customerservice.purchaseused"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="purchaseUsed" /></td>
                            </tr>
                         	<tr> 
                              <td class="desc_cell" nowrap  height="18" ><bean:message key ="customerservice.cashused"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="cashUsed" /></td>
                            </tr>             
                        	</table>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0" width="264">
                            <tr> 
                              ...
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="cardNo" /></td>
                            </tr>
                            
                            <tr> 
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.cardproductname"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="cardProductName" /></td>
                            </tr>
							<tr> 
                              <td class="desc_cell" nowrap ><bean:message key ="customerservice.cardstatus"/></td>
                              <td class="label"><bean:write name ="accountAdjustmentForm"  property="cardStatus" /></td>
                            </tr>
                    ...
                    <tbody>
                      <tr>
                        <td width="335"><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerservice.accountadjustment"/></td>
                                <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                              </tr>
                            </tbody>
                        </table></td>
                      ...
                      <tr>
                        ...
                        Insert Code Here
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="264">
					      <tr> 
                                <td class="desc_cell" nowrap ><bean:message key ="customerservice.adjustmentamount"/></td>
                                <td class="label"><html:text name ="accountAdjustmentForm"  property="adjustmentAmount" /></td>
                                
                                
                            </tr>
                        
                            <tr>
		                      <td class="desc_cell"><bean:message key ="customerservice.creditordebit"/> * </td>
                              <td nowrap class="label">
                             	<html:radio property ="creditOrDebit" value ="C"><bean:message key ="customerservice.aacredit"/></html:radio>
                               	<html:radio property ="creditOrDebit" value ="D"><bean:message key ="customerservice.aadebit"/></html:radio>
                              </td>
	                      </tr>
                        
                            <tr>
		                      <td class="desc_cell"><bean:message key ="customerservice.tranxtype"/> * </td>
                              <td nowrap class="label">
                             	<html:select property="tranxType" >
	                      ...
	                      <tr>
	                      <td class="desc_cell" nowrap ><bean:message key ="customerservice.aareason"/></td>
                                <td class="label"><html:textarea name ="accountAdjustmentForm"  property="reason" rows="3"></html:textarea></td>
                            </tr>
