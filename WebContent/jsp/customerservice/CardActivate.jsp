...
<body bgcolor="ffffff">
   <html:form action="cardactivateprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.cardactivate"/></td>
        </tr>
        <tr>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.cardactivate"/></td>
              ...
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                   ...
                   <html:button property="submitbutton" onclick="go('cardactivate')" > <bean:message key ="common.activate"/></html:button>
                      ...
                      <tr>
                        <td height="96"><table border="0" cellpadding="0" cellspacing="0" width="264" height="96">
							...
							<tr> 
                              ...
                              <td class="label"><bean:write name ="custServObj"  property="status" /></td>
                            </tr>
