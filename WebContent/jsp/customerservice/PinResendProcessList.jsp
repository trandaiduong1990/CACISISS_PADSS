...
<html:html>
<head>
<title><bean:message key ="customerservice.pinresendsearch"/></title>
...
<body bgcolor="ffffff">
<html:form  action ="pinresendprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.pinresendsearch"/></td>
        </tr>
        <tr>
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157">
                ...
                <td class="texteMenuGauche"> 
                  <html:button property="submitbutton" onclick="go('pinResendProcessSearch')" ><bean:message key ="common.search"/></html:button>   
...
<br><logic:present name="SEARCHLIST" scope="request"> 
  <display:table  id="cardRepProcess" name="requestScope.SEARCHLIST"  
   ...
   <display:column property="column4" title="CardNumber" class="label" />
   <display:column property="column3" title="Applied Date" class="label" />
   <display:caption><font class="titreSection">PinResend Form Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	   <form name ="listForm" action="pinresendlist.do">	 
	
              <html:hidden property="applicationId" value="<%= ((CommonDataBean)pageContext.getAttribute("cardRepProcess")).getColumn1()%>" />
              <html:hidden property="cardNumber" value="<%= ((CommonDataBean)pageContext.getAttribute("cardRepProcess")).getColumn5()%>" />
              <html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
              <html:hidden property="method" value ="pinResend"/>
