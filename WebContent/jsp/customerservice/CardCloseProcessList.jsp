...
<body bgcolor="ffffff">
<html:form  action ="cardcloseprocess.do">
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157">
                ...
                <td class="texteMenuGauche"> 
                  <html:button property="submitbutton" onclick="go('cardCloseProcessSearch')" ><bean:message key ="common.search"/></html:button>   
...
<br><logic:present name="SEARCHLIST" scope="request"> 
  <display:table  id="cardRepProcess" name="requestScope.SEARCHLIST"  
   ...
   <display:caption><font class="titreSection">Card Close Form Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	   <form name ="listForm" action="cardcloselist.do">	 
              ...
              <html:hidden property="method" value ="cardClose"/>
