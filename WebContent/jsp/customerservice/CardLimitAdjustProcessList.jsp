...
<html:html>
<head>
<title><bean:message key ="customerservice.cardlimitadjustsearch"/></title>
...
<body bgcolor="ffffff">
<html:form  action ="cardlimitprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.cardlimitadjustsearch"/></td>
        </tr>
        <tr>
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157">
                ...
                <td class="texteMenuGauche"> 
                  <html:button property="submitbutton" onclick="go('cardLimitProcessSearch')" ><bean:message key ="common.search"/></html:button>   
...
<br><logic:present name="SEARCHLIST" scope="request"> 
  <display:table  id="cardRepProcess" name="requestScope.SEARCHLIST"  
   ...
   <display:caption><font class="titreSection">CardLimitAdjustment Form Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	   <form name ="listForm" action="cardlimitlist.do">	 
              ...
              <html:hidden property="method" value ="cardLimitAdjust"/>
