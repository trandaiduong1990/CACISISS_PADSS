...
<html:html>
<head>
<title><bean:message key ="feewaiver.screentitle"/></title>
...
<script language="JavaScript" src="inc/js/FeeWaiver.js"></script>
...
function feewaive() {
	...
	document.forms[0].method.value="feeWave";
	document.forms[0].action ="feewaiverprocess.do";
	//document.forms[0].submit();
...
<body bgcolor="ffffff" >
<html:form action ="feewaiverprocess.do">

<input type="hidden" name="method" value ="">
<bean:define id="snos" name="feeWaiverForm" property="serialNosTowaive"/>
<html:hidden property="serialNosTowaive" value="<%=(String)snos%>"/>

<bean:define id="ct" name="feeWaiverForm" property="cardType"/>
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="feewaiver.screentitle"/></td>
        </tr>
        <tr>
            ...
            <tr>
              <td>
              	<html:button property="submitbutton" onclick="go('search')"><bean:message key ="common.search"/></html:button>
           		<logic:equal value="Y" property="butEnable" name="feeWaiverForm">
           			<html:button property="feewaive" onclick="go('feewaive')"><bean:message key ="common.feewaive"/></html:button>
           		</logic:equal>
              </td>
              <td>&nbsp;</td>
            </tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="feewaiver.cardno"/> </td>
                        <td><html:text property="cardNo" size="20"/></td>
                        <!-- <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT"><bean:message key ="feewaiver.csn"/> </td>
        ...
        <tr> 
          <td valign="top">
			...
			<logic:present name="SEARCHLIST" scope="request"> 
		     	<bean:size id ="size" name ="feeWaiverForm" property="feeList"/>
			                	...
			                	<tr>
			                      ...
			                      <table class="wrapper" border="0" cellspacing="1" cellpadding="2">
	                                <tr>
										...
										<td class="title" nowrap><bean:message key ="feewaiver.cardno"/></td>
	                                    <td class="title" nowrap><bean:message key ="feewaiver.date"/></td>
										<td class="title" nowrap><bean:message key ="feewaiver.des"/></td>
										<td class="title" nowrap><bean:message key ="feewaiver.amt"/></td>
										<td class="title" nowrap><bean:message key ="feewaiver.feewaived"/></td>
	                                 </tr>
		                               <logic:iterate id ="commObj" name ="feeWaiverForm" property="feeList">
										<bean:define id="sno" name="commObj" property="column1"/>
		                                  <tr>
		                                  	<td class="DataTD" nowrap>
		                                  	<logic:equal name="commObj" property="column6" value="N">
			                                  	<html:multibox property="selectedSerialNos" onclick='<%= "javascript:checkCommon(document.feeWaiverForm.selectedSerialNos,this,document.feeWaiverForm.serialNosTowaive, '"+sno+"');"%>' >
