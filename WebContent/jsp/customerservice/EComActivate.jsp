...
<body bgcolor="ffffff">
   <html:form action="ecomactivateprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.ecom"/></td>
        </tr>
        <tr>
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157" align="left">
                ...
                <td class="texteMenuGauche"> 
                  <html:button property="submitbutton" onclick="go('searchECom')" ><bean:message key ="common.search"/></html:button> 
                 </td>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.ecom"/></td>
              ...
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right">
                    	<logic:equal value="N" name="cardReplacementForm" property="eComEnable">
                  	 		<html:button property="submitbutton" onclick="go('eComEnableDisable')" > <bean:message key ="common.ecomed"/></html:button>
                  	 	</logic:equal>
                    	<logic:equal value="Y" name="cardReplacementForm" property="eComEnable">
                   			<html:button property="submitbutton" onclick="go('eComEnableDisable')" > <bean:message key ="common.ecomed"/></html:button>
                  	 	</logic:equal>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="72">
                             ...
                             <tr >
                               <td class="desc_cell"><bean:message key ="customerservice.ecomstatus"/></td>
                               <td nowrap class="label">
                               	<html:radio property ="eComEnable" value ="Y"><bean:message key ="customerservice.ecomstatusen"/></html:radio>
                                <html:radio property ="eComEnable" value ="N"><bean:message key ="customerservice.ecomstatusdi"/></html:radio>
                                </td>
                             </tr>
