...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Transaction GL History"; %>
			<tr class="desc_cell">
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<table>
							...
							<tr>
								<td class="desc_cell" style="width: 120px;">Card Product Type:</td>
								<td>
									<select name="CARD_PRODUCT_TYPE" size="1" class="form_field">
									<%
									intArlSize = arlcardProductTypeList.size();
									String selectTypeText = new String();
									if (intArlSize != 0) {
										for (int intIndex = 0; intIndex < intArlSize; intIndex++) {
											...
											if (strcardProductType != null && strcardProductType.trim().equalsIgnoreCase(zszAcqId))
												selectTypeText = "selected";
									%>
									<option value="<%=zszAcqId%>" <%=selectTypeText%>><%=zszAcqName%></option>
											<%}
										}%>
									</select>
								</td>
							...
							<tr>
								<td class="desc_cell" style="width: 120px;">Card Product:</td>
								<td>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','TRNXGLHIS','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXGLHIS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXGLHIS', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','TRNXGLHIS','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','TRNXGLHIS','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
