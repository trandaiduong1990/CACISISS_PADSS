...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Batch Process"; %>
			<tr class="desc_cell">
						...
						<table>
							...
							<tr>
								...
								<div align="left">
									...
									<input type="button" onClick="javascript:setmode(4,'Down','BATCHPROCESS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','BATCHPROCESS', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
