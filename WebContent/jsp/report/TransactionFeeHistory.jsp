...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Transaction & Fee History"; %>
			<tr class="desc_cell">
					...
					<tr>
						...
						<table>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','TRNXFEEHIS','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXFEEHIS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXFEEHIS', 2)" value="Excel Download " name="PDF">	
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','TRNXFEEHIS','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','TRNXFEEHIS','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						...
						<td class="texts" nowrap><b> Description </b></td>
						<td class="texts" nowrap><b> Amount </b></td>
						<td class="texts" nowrap><b> Amount Sign</b></td>
						<td class="texts" nowrap><b> Ref ID</b></td>
					</tr>
					<%
