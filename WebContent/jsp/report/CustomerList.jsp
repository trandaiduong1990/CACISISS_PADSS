...
String strReportCode = "";
	...
	if (session.getAttribute("REPORT_VIEW_DATA_OBJECT") != null) {
		...
		strcustName = objReportViewBean.getCustomerName();
		strdob = objReportViewBean.getDob();
		strgender = objReportViewBean.getGender();
...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Customer List"; %>
			<tr class="desc_cell">
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<table>
							...
							<tr>
								<td class="desc_cell" style="width: 90px;">Card Product:</td>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" name="CUST_NAME" size="16" value="<%=strcustName%>" class="form_field">
								</td>
							</tr>
							<tr>
								<td class="desc_cell">DOB:</td>
								<td>
									<input type="text" name="DOB" size="16" maxlength="16" value="<%=strdob%>" class="form_field">
									<a href="#" onClick="show_calendar('forms[0].DOB', null, null, 'DD/MM/YYYY', null, null)"> 
                                	(DD/MM/YYYY)
                                	</a>
								</td>
							</tr>
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','CUSTLIST','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','CUSTLIST', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','CUSTLIST', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','CUSTLIST','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','CUSTLIST','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						...
						<td class="texts" nowrap><b> Customer Surname </b></td>
						<td class="texts" nowrap><b> Date of Birth </b></td>
