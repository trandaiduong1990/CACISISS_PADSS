...
String strReportCode = "";
	...
	String strMode = "";
	String strOpCode = "";
	String strcardProductType = "";
	ArrayList arlcardProductTypeList = new ArrayList();
	...
	if (session.getAttribute("REPORT_VIEW_DATA_OBJECT") != null) {
		...
		strcardProductType = objReportViewBean.getCardProductType();
		arlcardProductTypeList = objReportViewBean.getArlCardProductTypeList();
...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Card Holder Statistics"; %>
			<tr class="desc_cell">
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<table>
							...
							<tr>
								<td class="desc_cell" >Card Product Type:</td>
								<td>
									<select name="CARD_TYPE" size="1" class="form_field">
									<option value=""></option>
									<%
									intArlSize = arlcardProductTypeList.size();
									String zszSelectedTextType = new String();
									if (intArlSize != 0) {
										for (int intIndex = 0; intIndex < intArlSize; intIndex++) {
											Hashtable AcqDetails = (Hashtable) arlcardProductTypeList.get(intIndex);
											String zszAcqId = (String) AcqDetails.get("PRODUCT_TYPE_ID");
											String zszAcqName = (String) AcqDetails.get("PRODUCT_TYPE_DESC");
											zszSelectedTextType = "";
											if (strcardProductType != null && strcardProductType.trim().equalsIgnoreCase(zszAcqId))
												zszSelectedTextType = "selected";
									%>
									<option value="<%=zszAcqId%>" <%=zszSelectedTextType%>><%=zszAcqName%></option>
											<%}
										}%>
									</select>
								</td>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','CARDHOLDERSTATISTICS','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','CARDHOLDERSTATISTICS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','CARDHOLDERSTATISTICS', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','CARDHOLDERSTATISTICS','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','CARDHOLDERSTATISTICS','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						<td class="texts" nowrap><b> Card Product Type </b></td>
						<td class="texts" nowrap><b> No Of Cards at Beginning </b></td>
						<td class="texts" nowrap><b> New Cards on Time Period </b></td>
						<td class="texts" nowrap><b> Renewed Cards on Time Period </b></td>
						<td class="texts" nowrap><b> Closed Cards on Time Period </b></td>
						<td class="texts" nowrap><b> No Of Cards at End </b></td>
						<td class="texts" nowrap><b> Processed Applications on Time Period </b></td>
						<td class="texts" nowrap><b> Pending Applications on Time Period </b></td>
						<td class="texts" nowrap><b> Rejected Applicatios on Time Period </b></td>
					</tr>
					<%
					...
					<tr valign="top" class="ReportDataTD">
						...
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn2()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn3()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn4()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn5()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn6()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn7()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn8()%></td>
						<td class="texts" nowrap align="center"><%=objReportsDataBean.getColumn9()%></td>
					</tr>
					<%}%>
				</table>
				</td>
