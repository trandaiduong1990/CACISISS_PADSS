...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Application Status"; %>
			<tr class="desc_cell">
					...
					<tr>
						...
						<table>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','APPSTATUS','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','APPSTATUS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','APPSTATUS', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','APPSTATUS','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','APPSTATUS','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						...
						<td class="texts" nowrap><b> Card Type </b></td>
						<td class="texts" nowrap><b> Card Product ID </b></td>
						<td class="texts" nowrap><b> Card Product Name </b></td>
						<td class="texts" nowrap><b> New </b></td>
						<td class="texts" nowrap><b> Approved </b></td>
						<td class="texts" nowrap><b> Rejected </b></td>
						<td class="texts" nowrap><b> Processed </b></td>
						<td class="texts" nowrap><b> Pending </b></td>
					</tr>
					<%
