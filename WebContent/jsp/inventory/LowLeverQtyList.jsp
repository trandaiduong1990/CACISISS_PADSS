  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="lowlevel.titreSection"/></td>
        </tr>
        <tr>
...
<br/>
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="40%">
	   	<display:column property="column1" title="Card Product" class="label" />
	   	<display:column property="column2" title="Min Level" class="label" />
	   	<display:column property="column3" title="Current Level" class="label" />
	   	<display:caption><font class="titreSection">Low Level QTy Records</font></display:caption>
    </display:table>
   </logic:present>
    </td>
        </tr>
