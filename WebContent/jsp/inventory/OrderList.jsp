  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="orderlist.titreSection"/></td>
        </tr>
        <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="orderlist.status"/></td>
                        <td> 
                        	<html:select property="status" >
                        		<html:option value=""> </html:option>	
                        		<html:option value="O">Order</html:option>	
                        		<html:option value="A">Authorized</html:option>	
                        		<html:option value="D">Dispatched</html:option>	
                        		<html:option value="All">All</html:option>	
					        </html:select>
                        </td>
                        <td style="width: 20px;"></td>
                         <td class="ColumnFONT"><bean:message key ="orderlist.branch"/></td>
                        <td> 
...
<br/>
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="90%">
	   	...
	   	<display:caption><font class="titreSection">Order List Records</font></display:caption>
    </display:table>
   </logic:present>
    </td>
        </tr>
