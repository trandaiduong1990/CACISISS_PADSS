...
<body onLoad="showInitTab();disableTab4();onLoadCheckBox(this);update();accLinkUpdate();">
<html:form action="appprocess.do">
<input type="hidden" name="method"/>
<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
<html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>
<html:hidden property="applicationId" />
<input type="hidden" id="ACCDETTAB" name="ACCDETTAB" value="<%=(String)request.getAttribute("ACCDETTAB")%>" />
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="applicationprocess.screentitle"/> </td>
  ...
  <tr> 
              ...
              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        ...
                        <td id="tab4bg" background="images/form_tab_bg_off.gif" class="form_tab_off">
                        	<a name="accDetails" id="accDetails" href="javascript:switchMenu('tab4')"><bean:message key ="applicationform.tab4"/></a>
                        </td>
                    ...
                    <%
					  if(((String)request.getAttribute("ACTION")).equals("change") || ((String)request.getAttribute("ACTION")).equals("update"))		
        				    { %>
					         ...
					         <html:button property="pending" onclick="accRej('pending')"><bean:message key ="common.pending"/></html:button>
                ...
                <tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="264" height="36">
                       <tr>
                      	<td colspan="5">
                  			...
                  			<div id="demoReplyAccDet" style="padding-bottom: 10px;width: 500px;color: green;height: 10px;"></div>
                      	</td>
                      </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colspan="3" class="label"><table border="0" cellspacing="0" cellpadding="0">
                      		<logic:iterate id="appcardprods" name ="applicationProcessSetup" property="appCardProductList">
	                         <%
	                          ...
	                          <%if(cardProductName.startsWith("V")){ %>
	                            <tr>
	                              <td nowrap class="label">
	                            	<html:radio property="selectedAppCardProducts" value="key" idName="appcardprods" onclick="update();accLinkUpdate();"  />
                            ...
                            <tr>
                              <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="144">
                                  ...
                                  <tr bordercolor="#111111" style="height: 40px;">
                                    ...
                                    <td><html:text property="embossingName" styleId="embossingName" size="20" onkeyup="javascript:countCharacters('demoReply3','embossingName');"/></td>
                                    <td>
                                  ...
                                  <tr bordercolor="#111111">
                                    ...
                                    <td><html:text property="strDob" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strDob)"/></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.pob"/></td>
                                    <td><html:text property="pob" size="20" maxlength="100"/></td>
                                  </tr>
                                  ...
                                  <tr bordercolor="#111111">
                                    ...
                                    <td><html:text property="strIdDate" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strIdDate)"/></td>
                                  </tr>
                                  ...
                                  <tr bordercolor="#111111">
                                    ...
                                    <td><html:text property="strExpDate" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strExpDate)"/></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                            ...
                            <tr>
                              <td height="159"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	<div id="home_stateText">
                                    		<logic:equal name="applicationProcessSetup" property="homeAddress.country" value="MM">
											...
											<logic:notEqual  name="applicationProcessSetup" property="homeAddress.country" value="MM">
                                  ...
                                  <tr>
                                    ...
                                    <td><html:text property="homeAddress.postalCode" size="20" maxlength="5"/></td>
                                  </tr>
                                  <tr>
                                    <td class="desc_cell"><bean:message key ="applicationform.phone"/> * </td>
                                    <td><html:text property="homeAddress.phone" size="20" maxlength="12"/></td>
                                  </tr>
                                  <tr>
                                    <td class="desc_cell"><bean:message key ="applicationform.fax"/></td>
                                    <td><html:text property="homeAddress.fax" size="20" maxlength="12"/></td>
                                  </tr>
                              </table></td>
                            </tr>
                          </tbody>
                      ...
                      <tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="54">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	<div id="company_stateText">
                                    		<logic:equal name="applicationProcessSetup" property="companyAddress.country" value="MM">
											...
											<logic:notEqual  name="applicationProcessSetup" property="companyAddress.country" value="MM">
                                  ...
                                  <tr>
                                    <td class="desc_cell" nowrap width="132"><bean:message key ="applicationform.postalcode"/> </td>
                                    <td><html:text property="companyAddress.postalCode" size="20" maxlength="5"/></td>
                                  </tr>
                                  <tr>
                                    <td class="desc_cell"><bean:message key ="applicationform.phone"/></td>
                                    <td><html:text property="companyAddress.phone" size="20" maxlength="12"/></td>
                                  </tr>
                                  <tr>
                                    <td class="desc_cell"><bean:message key ="applicationform.fax"/></td>
                                    <td><html:text property="companyAddress.fax" size="20" maxlength="12"/></td>
                                  </tr>
                        ...
                        <td valign="top" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="274" height="54">
                                  <tr bordercolor="#111111">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr bordercolor="#111111">
                                    <td height="25" nowrap><table border="0" cellspacing="0" cellpadding="0">
                                      <tr bordercolor="#111111">
				  ...
				  <div id="tab3">
                        ...
                        <td width="48%" valign="top" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                            ...
                            <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="264" height="144">
                                 <tr bordercolor="#111111">
                                  ...
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.embossingName"/></td>
                                    <td><html:text property="supplEmbossingName" size="20"/></td>
                                    <td><div id="demoReply11" style="color: green;width: 70px;"></div></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.dob"/></td>
                                    <td><html:text property="strSupplDob" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strSupplDob)"/></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.pob"/></td>
                                  ...
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.iddate"/></td>
                                    <td><html:text property="strSupplIdDate" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strSupplIdDate)"/></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.expdate"/> </td>
                                    <td><html:text property="strSupplIdExpire" size="20" onblur="javascript:isValidDate(document.applicationProcessSetup.strSupplIdExpire)"/></td>
                                  </tr>
                                  <tr bordercolor="#111111">
                                    <td class="desc_cell"><bean:message key ="applicationform.idplace"/></td>
                         ...
                         <td valign="top" style="padding: 20px 20px 10px 20px;"><table width="335" 
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td bgcolor=#dce5ea><div id="suppStyle"  style="FONT-SIZE: 1px;display: none;">&nbsp;</div></td>
                            </tr>
                            <tr>
                              <td height="159">
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	<div id="supplementary_stateText">
                                    		<logic:equal name="applicationProcessSetup" property="supplementaryAddress.country" value="MM">
											...
											<logic:notEqual  name="applicationProcessSetup" property="supplementaryAddress.country" value="MM">
                                  ...
                                  <tr>
                                    <td class="desc_cell" nowrap width="132"><bean:message key ="applicationform.postalcode"/> </td>
                                    <td><html:text property="supplementaryAddress.postalCode" size="20" maxlength="5"/></td>
                                  </tr>
                                  <tr>
                                    <td class="desc_cell"><bean:message key ="applicationform.phone"/></td>
                    ...
                    <tr>
                      	<td colspan="5">
                  			<div id="demoReply2" style="padding-bottom: 10px;width: 500px;color: green;height: 10px;padding-left: 20px;"></div>
                      	</td>
                      </tr>
                      <!-- 
                      <tr>
                        ...
                        <td colspan="3" valign="top" style="padding: 20px 20px 10px 20px;">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <table cellspacing=0 cellpadding=0 border=0>
                                    <tbody>
                                      <tr>
                                        <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                        <td class=group_title background=images/tab_fond.gif><bean:message key ="applicationprocess.editremarks"/></td>
                                        <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                                      </tr>
                                    </tbody>
                                </table></td>
                              ...
                              <tr>
                                <td><table border="0" cellpadding="0" cellspacing="0" width="264">
                                    <tr bordercolor="#111111">
                                      <td class="desc_cell"><bean:message key ="applicationprocess.editremark"/></td>
   ...
   <display:caption><font class="titreSection">CustomerHistory Details </font></display:caption>
      ...
      <logic:notPresent name="CUSTOMERHISTORYLIST" scope="request">   
		                    	<div id="demoReply3" style="padding-bottom: 10px;width: 500px;color: green;height: 10px;padding-left: 20px;">
		                    		<bean:message key ="alert.nocustomerhistory"/>
		                    	</div>
		                    </logic:notPresent> 
                        </td>
