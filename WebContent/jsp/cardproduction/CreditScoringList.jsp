...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="creditscoringprocess.do?method=addNew";
...
<html:form action ="creditscoringlist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="creditcsoring.titlenew"/></td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="creditscoring.name"/></td>
                        <td> 
                        	<html:select property="scoreName" >
                        		<html:option value=""> </html:option>	
					         	<html:optionsCollection property="scoreNameList" value="key" label="value" />
					        </html:select>
                        </td>
   ...
   <br><logic:present name="SEARCHLIST" scope="request">
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="70%">
	   	<display:column property="column2" title="Credit Scoring Name" class="label" />
	   	...
	   	<font class="label"><display:column title="Edit" align="center" width="80" ></font>
			<form name ="listForm" action="creditscoringprocess.do">
