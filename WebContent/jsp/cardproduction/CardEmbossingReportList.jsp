...
<script language="JavaScript">
    ...
    function report() {
     	 document.forms[0].action="GenerateReportServlet.do?hdOpCode=4&mode=Down&REPORT_CODE=CES";
...
<body bgcolor="ffffff">
<html:form action ="cardembossingprocess.do">
 <input type="hidden" name="method" value ="">

<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
<html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>

<bean:define id="cardNums" name="cardEmbossingSearch" property="cardNos"/>
<bean:define id="eFile" name="cardEmbossingSearch" property="emossFile"/>
    ...
    <td valign="top">
     <br>
      <table width="100%">
        ...
        <tr> 
          <td valign="top">
			<logic:present name="cardEmbossingSearch" property="successCardsList"> 
			<bean:size id="size" name="cardEmbossingSearch" property="successCardsList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="cardEmboss" name="cardEmbossingSearch" property="successCardsList" class="simple" width="80%">
				   <display:column property="maskedCardNo" title="Card No" class="label" />
