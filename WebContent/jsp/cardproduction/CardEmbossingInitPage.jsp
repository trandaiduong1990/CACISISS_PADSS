  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="cardcardembossingsearch.screentitle"/></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td class="form_tab_on" background="images/form_tab_bg_on.gif" style="padding-left:15px"> 
                          <bean:message key ="cardemboss.embossing"/>
                        </td>
                                    ...
                                    <td> 
                                      <table cellspacing=0 cellpadding=0 border=0>
                                        ...
                                        <tr> 
                                          ...
                                          <td class=group_title background=images/tab_fond.gif><bean:message key ="cardemboss.types"/></td>
                                  ...
                                  <tr> 
                                    <td> 
                                      ...
                                      <tr> 
                                          ...
                                          <b>*</b>&nbsp;&nbsp;&nbsp;&nbsp;
                                          <html:link action="cardembossinglistpage.do"><bean:message key ="cardemboss.newcards"/></html:link>
                                          </td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                          <td class="desc_cell" nowrap>
                                          <b>*</b>&nbsp;&nbsp;&nbsp;&nbsp;
                                          <html:link action="cardembossingreplacementlistpage.do"><bean:message key ="cardemboss.replacementcards"/></html:link>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td nowrap width="132"></td>
                                        ...
                                        <tr> 
                                          <td class="desc_cell" nowrap>
                                          <b>*</b>&nbsp;&nbsp;&nbsp;&nbsp;
                                          <html:link action="cardembossingrenewallistpage.do"><bean:message key ="cardemboss.renewalcards"/></html:link>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td nowrap width="132"></td>
