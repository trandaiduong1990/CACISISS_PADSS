...
<html:html>
<head>
<title><bean:message key ="risktranxactionsearch.screentitle"/></title>
...
<html:form  action ="risktranxactionlist.do?method=search">	 
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="risktranxactionsearch.screentitle"/></td>
        </tr>
        <tr>
...
<br><logic:present name="SEARCHLIST" scope="request"> 
   ...
   <display:column property="column2" title="Risk Category" class="label" />     
   <display:column property="column3" title="Action" class="label" />
   <display:column property="column4" title="Send SMS Alert" class="label" />
   <display:column property="column5" title="Status" class="label" />
   <display:column property="column6" title="Updated Date" class="label" />      
   <display:caption><font class="titreSection">Risk Transaction Action Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	
  	   <form name ="listForm" action="risktranxactionprocess.do">	 

              <html:hidden property="riskId" value="<%= ((CommonDataBean)pageContext.getAttribute("appProcess")).getColumn1()%>" />                                                         
