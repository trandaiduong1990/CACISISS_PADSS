  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="disputemanagement.transactionsearch"/></td>
        </tr>
        <tr>
                ...
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr>
                        ...
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.terminalId"/> </td>
                        <td><html:text property="terminalId" size="25"/></td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.authcode"/> </td>
                        <td><html:text property="authCode" size="20"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.refno"/> </td>
                        <td><html:text property="refNo" size="25"/></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><html:text property="startDate" size="20" onblur="javascript:isValidDate(document.disTranxSearchForm.startDate)"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.enddate"/><bean:message key ="common.dateformat"/></td>
                        <td><html:text property="endDate" size="25" onblur="javascript:isValidDate(document.disTranxSearchForm.endDate)"/></td>
                      </tr>
                      <tr>
                      	<td style="padding-top: 10px;" colspan="5" nowrap class="ColumnFONT"><bean:message key ="disputemanagement.ttar"/>:</td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT" align="right"><bean:message key ="disputemanagement.ttarfrom"/> </td>
                        <td><html:text property="amtFrom" size="20"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT" align="right"><bean:message key ="disputemanagement.ttarto"/> </td>
			              ...
			              <td>
			                ...
			                <tr>
							     <td style="PADDING-RIGHT: 20px; PADDING-LEFT: 20px; PADDING-TOP: 10px">
							     	<b><bean:write name="disTranxSearchForm" property="totalCount"/></b>
