...
<body bgcolor="ffffff" >
<html:form action ="chargeBackResendList.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="disputemanagement.cb.re.transactionsearch"/></td>
        </tr>
        <tr>
                ...
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      ...
                      <tr>
                       ...
                       -->
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.cb.re.authcode"/> </td>
                        <td><html:text property="authCode" size="25"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.cb.re.arn"/> </td>
                        <td><html:text property="arn" size="25"/></td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.cb.re.startdate"/><bean:message key ="common.dateformat"/></td>
                        <td><html:text property="startDate" size="25" onblur="javascript:isValidDate(document.chargeBcakResendSearchForm.startDate)"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT"><bean:message key ="disputemanagement.cb.re.enddate"/><bean:message key ="common.dateformat"/></td>
                        <td><html:text property="endDate" size="25" onblur="javascript:isValidDate(document.chargeBcakResendSearchForm.endDate)"/></td>
                      </tr>
                      <tr>
                      	<td style="padding-top: 10px;" colspan="5" nowrap class="ColumnFONT"><bean:message key ="disputemanagement.cb.re.ttar"/>:</td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT" align="right"><bean:message key ="disputemanagement.cb.re.ttarfrom"/> </td>
                        <td><html:text property="amtFrom" size="25"/></td>
                        <td style="width: 30px;"></td>
                        <td nowrap class="ColumnFONT" align="right"><bean:message key ="disputemanagement.cb.re.ttarto"/> </td>
			              ...
			              <td>
			                ...
			                <tr>
							     <td style="PADDING-RIGHT: 20px; PADDING-LEFT: 20px; PADDING-TOP: 10px">
							     	<b><bean:write name="chargeBcakResendSearchForm" property="totalCount"/></b>
			                 ...
			                 <tr>
			                      ...
			                      <table class="wrapper" border="0" cellspacing="1" cellpadding="2">
	                                <tr>
		                                ...
		                                <bean:define id="disMngAlrtBuff" name="chargeBcakResendSearchForm" property="disMngAltBuff" />
