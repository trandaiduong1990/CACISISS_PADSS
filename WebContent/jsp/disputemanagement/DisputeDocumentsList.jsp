				...
				<table border="0" cellspacing="2" cellpadding="2" width="157">
					<tr>
						<td class="texteMenuGauche"><html:form
							...
							</html:button>&nbsp;&nbsp;<html:button property="submitbutton" onclick="go('change')">
								<bean:message key="common.inquiry" />
							</html:button></p></td>
					</tr>
				</table>
				</td>
			...
			<tr>
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td><font class="label"><bean:message
									key="disputedocumentssetup.reasoncode" /></font> <html:select
									property="reasonCode">
									<html:option value=""></html:option>
									<html:optionsCollection property="reasonCodeList" value="key"
										label="value" />
								</html:select></td>
							</tr>
				...
				<br><logic:present name="SEARCHLIST" scope="request">
					<display:table id="appProcess" name="requestScope.SEARCHLIST"
						...
						<display:column property="column1" title="Reason Code"
							class="label" />
						<display:column property="column2" title="Description"
							class="label" />
						<display:column title="Details" align="center" width="80">

							<form name="listForm" action="disputedocumentsprocess.do">
