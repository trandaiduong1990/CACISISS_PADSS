...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="collectionageingactionprocess.do?method=addNew";
...
<html:form action ="collectionageingactionlist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="collectionageingaction.titreSection"/></td>
        </tr>
        <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="collectionageingaction.ageingPolicy"/></td>
                        <td> 
                        	<html:select property="ageingPolicy" >
...
<br/>
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="90%">
	   	...
	   	<display:column property="column2" title="Days" class="label" />
	   	<display:column property="column3" title="Phone" class="label" />
	   	<display:column property="column4" title="Remainder" class="label" />
	   	<display:column property="column5" title="Remainder Type" class="label" />
	   	<display:column property="column6" title="Card Block" class="label" />
	   	<display:column property="column7" title="Write-off" class="label" />
	   	<display:caption><font class="titreSection">Collection Agent Action Records</font></display:caption>
	   	<font class="label"><display:column title="" align="center" width="80" >
			<form name ="listForm" action="collectionageingactionprocess.do">
				<html:hidden property="sno" value="<%= ((CommonDataBean)pageContext.getAttribute("commonObj")).getColumn8()%>" />       
