...
<html:html>
<head>
<title><bean:message key ="collectionconfig.screentitle"/></title>
...
<body>
 <html:form action="collectionconfigprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="550"><bean:message key ="collectionconfig.screentitle"/></td>
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="collectionconfig.grouptitle1"/>                        </td>
                    ...
                    <tbody>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="collectionconfig.grouptitle1"/></td>
                     ...
                     <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td class="desc_cell" nowrap width="132"><b><bean:message key ="co.minAmount"/></b></td>
                              <td valign="top" width="242"><html:text property="minAmount" size="20"/></td>
                              <td>&nbsp;</td>                              
                            </tr>                            
                        </table></td>
                      </tr> 
                     <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td class="desc_cell" nowrap width="132"><b><bean:message key ="co.minDays"/></b></td>
                              <td valign="top" width="242"><html:text property="minDays" size="20"/></td>
                              <td>&nbsp;</td>                              
                            </tr>                            
                        </table></td>
                      </tr> 
                     <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td class="desc_cell" nowrap width="132"><b><bean:message key ="co.smsNotification"/></b></td>
                              <td valign="top" width="242"><html:checkbox property ="smsNotification" value="Y"/></td>
                              <td>&nbsp;</td>                              
                            </tr>                            
                        </table></td>
                      </tr>        
                     <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td class="desc_cell" nowrap width="132"><b><bean:message key ="co.emailNotification"/></b></td>
                              <td valign="top" width="242"><html:checkbox property ="emailNotification" value="Y"/></td>
                              <td>&nbsp;</td>                              
                            </tr>                            
                        </table></td>
                      </tr>        
