                ...
                <tr>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td style="padding: 20px 20px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="collectionageing.ageingPolicy"/> * </b></td>
                          <%if(request.getAttribute("ACTION")!= null && !((String)request.getAttribute("ACTION")).equals("add"))		
        				    { %>
        				    <td class="label" >
        				    		<html:hidden property="ageingPolicy" name="collectionAgeingSetupForm" />
	                          		<bean:write name="collectionAgeingSetupForm" property="ageingPolicy"/></td>
	                          		<%}else{ %>
                          	<td>
                          		<html:text property="ageingPolicy" size="6"/>
							</td>
							<%} %>
                        </tr>
                        <tr>
                        	<td class="desc_cell" nowrap><b><bean:message key ="collectionageing.startDay"/> * </b></td>
                        	<td><html:text property="startDays" size="6"/></td>
                        </tr>
                        <tr>
                        	<td class="desc_cell" nowrap><b><bean:message key ="collectionageing.endDay"/> * </b></td>
                        	<td><html:text property="endDays" size="6"/></td>
                        </tr>
                        <tr>
                        	<td class="desc_cell" nowrap><b><bean:message key ="collectionageing.bucket"/> * </b></td>
                        	<td><html:text property="bucket" size="6"/></td>
                        </tr>
                      </table></td>
                      </tr>
                  </table></td>
