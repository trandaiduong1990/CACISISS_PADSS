...
<script language="JavaScript">
   function go(action) {
     ...
     function showList(){
          document.forms[0].action= "delinquencypolicylist.do?method=List&back=true";
          document.forms[0].submit();
       } 
</script>
...
<body bgcolor="ffffff">
 <html:form action="delinquencypolicyprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="504"><bean:message key ="co.policySetupTitle"/></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td class="form_tab_on" background="images/form_tab_bg_on.gif" style="padding-left:15px"> 
                         <bean:message key ="co.policySetupTitle"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="padding: 20px 20px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.policyId"/> * </b></td>
                           <%if(request.getAttribute("ACTION")!= null && !((String)request.getAttribute("ACTION")).equals("add"))		
        				    { %>
        				    <td class="label" ><html:hidden property="policyId" name="delinquencyPolicyForm" />
	                          		<bean:write name="delinquencyPolicyForm" property="policyId"/></td>
	                          		<%}else{ %>
                          <td><html:text property="policyId" maxlength="12" size="25"/></td>
                          <%} %>
                        </tr>
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.policyDesc"/> * </b></td>
	                      <td><html:text property="description" maxlength="20" size="25"/>
	                      </td>    		
