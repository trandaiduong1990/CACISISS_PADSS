...
<script language="JavaScript">
   function go(action) {
     ...
     function showList(){
          document.forms[0].action= "delinquencynotificationsetuplist.do?method=List";
          document.forms[0].submit();
       } 
</script>
...
<body bgcolor="ffffff">
 <html:form action="delinquencynotificationetupprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="504"><bean:message key ="co.notifySetupTitle"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <%if(request.getAttribute("ACTION")!= null && !((String)request.getAttribute("ACTION")).equals("add"))		
        				    { %>
        				    <td class="label" ><html:hidden property="policyId" name="delinquencyNotificationSetupForm" />
	                          		<bean:write name="delinquencyNotificationSetupForm" property="policyName"/></td>
	                          		<%}else{ %>
                          <td>
                ...
                <tr>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                      	  ...
                      	  <td style="padding: 0px 0px 0px 20px;" valign="top"><table cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="group_title" background="images/tab_fond.gif"><bean:message key ="co.notiSubhead1"/></td>
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.aging"/> * </b></td>
                          <td><html:text property="agingSeverity" size="15" styleClass="padLeft"/></td>
                        </tr>
                        <tr>
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.threhold"/> * </b></td>
                          <td><html:text property="thresholdPer" size="15" styleClass="padLeft"/></td>
                        </tr>
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.payByDays"/> * </b></td>
	                      <td><html:text property="payByDays" size="15" styleClass="padLeft"/></td>	
                        </tr>
                      </table></td>
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.daysBetweenNoti"/> * </b></td>
	                      <td><html:text property="notificationBtwDays" size="15" styleClass="padLeft"/></td>	
                        </tr>
                      </table></td>
                      </tr>
                  </table></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                      	  <td style="padding: 0px 0px 0px 20px;" valign="top"><table cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                  <tr>
                                    <td><img height="19" alt="" src="images/tab_g.gif" width="8" border="0"></td>
                                    <td class="group_title" background="images/tab_fond.gif"><bean:message key ="co.notiSubhead2"/></td>
                                    <td><img height="19" alt="" src="images/tab_d.gif" width="8" border="0"></td>
                                  </tr>
                                </tbody>
                            </table>
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
	                      ...
	                      <td><html:checkbox property ="notifyReq" value="Y"/></td>	
                        </tr>
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="co.exCoReq"/></b></td>
	                      <td><html:checkbox property ="externalCollectionReq" value="Y"/></td>	
                        </tr>
                      </table></td>
                      ...
                      <td style="padding: 0px 0px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
	                      ...
	                      <td><html:checkbox property ="mgmrApprReq" value="Y"/></td>	
                        </tr>
                      </table></td>
                      </tr>
                  </table></td>
