...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="collectionagentsetupprocess.do?method=addNew";
...
<html:form action ="collectionagentsetuplist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="collectionAgent.screentitle"/></td>
        </tr>
        <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="collectionagent.agentName"/></td>
                        <td> 
...
<br/>
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="70%">
	   	<display:column property="column1" title="Agent Name" class="label" />
	   	<display:column property="column2" title="Contact Name" class="label" />
	   	<display:column property="column3" title="Contact Phone No" class="label" />
	   	<display:column property="column4" title="Email ID" class="label" />
	   	<display:caption><font class="titreSection">Collection Agent Records</font></display:caption>
	   	<font class="label"><display:column title="" align="center" width="80" >
			<form name ="listForm" action="collectionagentsetupprocess.do">
