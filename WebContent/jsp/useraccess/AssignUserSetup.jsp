...
<script language="JavaScript">
   ...
   function showList(){
          document.forms[0].action= "assignuserlist.do?method=List";
          document.forms[0].submit();
       }  
</script>
...
<body bgcolor="ffffff">
<html:form action="assignuserprocess.do">
                ...
                <tr>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="assignuser.role"/> * </b></td>
                                <td>	
                              ...
                              <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="assignuser.user"/> * </b></td>
                                <td valign="top">
                        	...
                        	<tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="assignuser.lower"/> </b></td>
                                <td><html:text property="lower" size="14" maxlength="14"/>                                </td>
                              </tr>
                              <tr>
                                <td class="desc_cell" nowrap><b><bean:message key ="assignuser.upper"/> </b></td>
                                <td><html:text property="upper" size="14" maxlength="14"/>                               </td>
                              </tr>
                      </table></td>
                      </tr>
