...
<html:html>
<head>
<title><bean:message key="chletterhistsetup.screentitle" /></title>
...
<body bgcolor="ffffff">
<html:form action="chletterhistlist">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td class="titreSection"><bean:message
					key="chletterhistsetup.screentitle" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="2" width="157">
					<tr>
						...
						<p class="titreSection"><html:hidden property="action" value="search" /><html:button property="submitbutton" onclick="searchlist()">
							...
							<table cellpadding="0" cellspacing="4">
								<tr>
									<td nowrap class="ColumnFONT"><font class="label"><bean:message
										key="chletterhistsetup.letterTypes" /></font></td><td> <html:select
										property="letterId">
								...
								<tr>
									...
									<td>
										<html:text
										property="cardNumber" size="21" maxlength="19" onkeypress="return disableEnterKey(event)" /> </td>
								</tr>
					...
					<logic:present name="SEARCHLIST" scope="request">
						<display:table id="appProcess" name="requestScope.SEARCHLIST"
							...
							<display:column property="column4" title="Letter Type"
								class="label" />
							<display:column property="column5" title="Dispatch Date"
								class="label" />	
						</display:table>
					</logic:present></td>
			</tr>
