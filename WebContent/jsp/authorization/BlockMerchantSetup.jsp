...
{
	//alert("showList()");
 document.forms[0].action="blockMerchantlistpage.do";
 document.forms[0].submit();
}
...
<body>
 <html:form action="blockmerchantprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="blockMerchantsetup.screentitle"/></td>
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="blockMerchantsetup.grouptitle1"/>                        </td>
                ...
                <tr> 
                  ...
                  <td colspan="2" valign="top" class="form_bgcolor" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                    ...
                    <tbody>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td nowrap class=group_title background=images/tab_fond.gif><bean:message key ="blockMerchantsetup.grouptitle1"/></td>
                      ...
                      <tr>
                        <td class="desc_cell" nowrap width="132"><b><bean:message key ="blockMerchantsetup.merchantid"/></b></td>
                        <td valign="top" width="242"><html:text property="searchMerchantId" size="20" onkeypress="return disableEnterKey(event)"/></td>
                        <td>&nbsp;</td>                              
                      </tr>
                       <tr>
                      <td class="desc_cell" nowrap width="132"><b><bean:message key ="blockMerchantsetup.merchantname"/></b></td>
                      <td valign="top" width="242"><html:text property="merchantName" size="20" onkeypress="return disableEnterKey(event)"/></td>
                      
                      </tr>
                      <tr> 
		       	<td class="desc_cell" nowrap width="132"><b><bean:message key ="blockMerchantsetup.block"/></b></td>
		          <td valign="top" width="242">
		            <html:select property="blockStatus" >
		              <!-- html:option value=""--><!--/html:option-->
		              <html:optionsCollection property="blockStatusList" value="key" label="value" />
		 	    </html:select>
		      	</td>
		      	
                      </tr>
                      <tr>
                      <td class="desc_cell" nowrap width="132"><b><bean:message key ="blockMerchantsetup.reason"/></b></td>
                      <td valign="top" width="242"><html:text property="reason" size="20" onkeypress="return disableEnterKey(event)"/></td>
