...
function showList()
{
 ...
 document.forms[0].action="blacklistcardlistpage.do";
 document.forms[0].submit();
}
...
<body>
 <html:form action="blacklistcardprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="blacklistcardsetup.screentitle"/></td>
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="blacklistcardsetup.grouptitle1"/>                        </td>
                ...
                <tr> 
                  ...
                  <td colspan="2" valign="top" class="form_bgcolor" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                    ...
                    <tbody>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td nowrap class=group_title background=images/tab_fond.gif><bean:message key ="blacklistcardsetup.grouptitle1"/></td>
                      ...
                      <tr>
                        <td class="desc_cell" nowrap width="132"><b><bean:message key ="blacklistcardsetup.cardnumber"/></b></td>
                        <td valign="top" width="242"><html:text property="cardNumber" size="20" onkeypress="return disableEnterKey(event)"/></td>
                        <td>&nbsp;</td>                              
                      </tr>
                      <tr> 
		       	<td class="desc_cell" nowrap width="132"><b><bean:message key ="blacklistcardsetup.cardstatusid"/></b></td>
		          <td valign="top" width="242">
		            <html:select property="cardStatusId" >
