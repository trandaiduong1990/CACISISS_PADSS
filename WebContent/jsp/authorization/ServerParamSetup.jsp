...
<html:html>
<head>
<title><bean:message key ="serverparameter.screentitle"/></title>
...
<body>
 <html:form action="serverparameterprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="serverparameter.screentitle"/></td>
        ...
        <tr> 
          <td valign="top"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="serverparameter.grouptitle1"/>                        </td>
                    ...
                    <div align="right"> 
					   ...
					   <% if(((String)request.getAttribute("ACTION")).equals("change") || ((String)request.getAttribute("ACTION")).equals("update"))		
        					...
        					<html:button property="submitbutton" onclick="go('update')"><bean:message key ="common.save"/></html:button>       						        					
       						<html:link href="serverparameterlistpage.do"><bean:message key ="common.cancel"/></html:link>
                    ...
                    <tbody>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="serverparameter.grouptitle1"/></td>
                      ...
                      <tr>
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.serverport"/></b></td>
		        ...
		        <td><table border="0" cellpadding="0" cellspacing="0">
		            <tr>
		              <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.voiceport"/></b></td>
		        ...
		        <td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.datatimeout"/></b></td>
		      	...
		      	<td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.noworkerthread"/></b></td>
		      	...
		      	<td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.debuglevel"/></b></td>
		      	...
		      	<td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.mailserveraddress"/></b></td>
		      	...
		      	<td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.mailserverport"/></b></td>
		      	...
		      	<td><table border="0" cellpadding="0" cellspacing="0">
		      	    <tr>
		      	      <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.fromname"/></b></td>
		       ...
		       <td><table border="0" cellpadding="0" cellspacing="0">
		      	   <tr>
		      	     <td class="desc_cell" nowrap width="132"><b><bean:message key ="serverparameter.frommail"/></b></td>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
					  <logic:notPresent name="ButtonSelection" scope="request">
        				  <html:button property="submitbutton" onclick="go('update')" ><bean:message key ="common.save"/></html:button>
        				  
  					  </logic:notPresent>
					  <logic:present name ="ButtonSelection" scope ="request">			       		
   					  </logic:present>	
					  <html:reset><bean:message key ="common.reset"/></html:reset> 
                    </div>                  
				  </td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
