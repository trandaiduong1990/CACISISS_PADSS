...
public class DisputeChargeBackSetupForm extends ValidatorForm {
	...
	private TransactionLogForm tranxlogForm;
	private DisputeCleaningMasterForm disputeCleaningMasterForm;
	private Base2TranxCodeForm tranxCodeForm;
	...
	public void getPreListData() {
		...
		try {
			...
			if (motoList == null) {
				motoList = objDisputeManagementDAO.disputeMotoListData();
			}
	...
	public TransactionLogForm getTranxlogForm() {
		return tranxlogForm;
	}

	public void setTranxlogForm(TransactionLogForm tranxlogForm) {
		this.tranxlogForm = tranxlogForm;
	}
	...
	public Base2TranxCodeForm getTranxCodeForm() {
		return tranxCodeForm;
	}

	public void setTranxCodeForm(Base2TranxCodeForm tranxCodeForm) {
		this.tranxCodeForm = tranxCodeForm;
	}

	public Map getMotoList() {
		return motoList;
	}

	public void setMotoList(Map motoList) {
		this.motoList = motoList;
	}

	public String getDisMoto() {
		return disMoto;
	}

	public void setDisMoto(String disMoto) {
		this.disMoto = disMoto;
	}
