...
<body bgcolor="ffffff">
<html:form action="csrcardactivate.do">
          ...
          <tr> 
            <td valign="top" height="323"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.cardactivate"/></td>
                ...
                <tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('cardactivate')"> <bean:message key ="common.activate"/></html:button></td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
