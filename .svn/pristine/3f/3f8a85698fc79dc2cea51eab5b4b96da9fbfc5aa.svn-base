...
public class ApplicationSetupForm extends ValidatorForm {
	/*
	 * private String applicationId="1"; private String issuerId="Issuer1";
	 * private String strOpenDate ="12/04/2006";//new Date(); private String
	 * strCloseDate ="12/04/2006"; // = new Date(); private String
	 * applicationType= "1"; private String applicationStatus = "1"; private
	 * String temp="N"; private String branchId ="1"; private String
	 ...
	 * String strDob ="12/04/2006"; //= new Date(); private String pob
	 * ="nizamabad"; private String gender ="M"; private String maritalStatus=
	 * "S"; private String dependents = "5"; private String idNumber ="111";
	 * private String strIdDate ="12/04/2006"; //= new Date(); private String
	 * strExpDate="12/04/2006";// = new Date(); private String idPlace
	 * ="Hyderabad"; private String nationality ="Indian"; private String
	 * education ="MC"; private String email ="Satyam_java@yahoo.com"; private
	 * String billingTo ="H"; private String jobStatus ="Gd"; private String
	 * jobStatusOthers ="NA"; private String jobType ="Sw"; private String
	 * jobTypeOthers ="NA"; private String income ="3000"; private String
	 * referenceName ="YT"; private String referencePhone ="92811125"; private
	 * String referenceCompany ="JST"; private String referenceFax ="92811126";
	 * private String savingAccount="123456789"; private String checkingAccount
	 * ="987654321"; private boolean atmLink =true; private boolean
	 * supplCardRequired=false; private String supplCustomerName ="narsa";
	 * private String supplSurName="ddl" ; private String supplEmbossingName
	 * ="reddy"; private String strSupplDob="12/04/2006";// = new Date();
	 * private String supplPob ="Armoor"; private String supplGender ="M";
	 * private String supplMaritalStatus ="M"; private String
	 * supplIdNumber="222" ; private String strSupplIdDate="12/04/2006";// = new
	 * Date(); private String strSupplIdExpire="12/04/2006";// =new Date();
	 * private String supplIdPlace ="Chennai" ; private String supplNationality
	 * ="Indian" ; private String supplEmail ="Narsa_teacher@yahoo.com"; private
	 * String supplIncome ="5000"; private String remarks="Lower Income";
	 * private String userId; private String suppCardHolderRelationToPrimryCard;
	...
	public Set getApplicationAddress() {
		...
		try {
			...
			this.applicationAddress.add(objDto);
			objDto = new AddressDto();
			BeanUtils.copyProperties(objDto, getSupplementaryAddress());
			this.applicationAddress.add(objDto);
		} catch (Exception e) {
	...
	public AddressForm getCompanyAddress() {
		...
		// System.out.println("\n\n address Id in company"
		// +IdsGenartion.GenerateAddessId());
		// companyAddress.setAddressId(IdsGenartion.GenerateAddessId());
	...
	public AddressForm getHomeAddress() {
		...
		// System.out.println("\n\n address Id in home"
		// +IdsGenartion.GenerateAddessId());
		//homeAddress.setAddressId(IdsGenartion.GenerateAddessId());
	...
	public void getPreListData() {
		...
		try {
			ApplicationFormDAO objDAO = DAOFactory.getInstance()
					.getApplicationFormDAO();
			...
			System.out
					.println("Error while getting  PreListData in ApplicationSetupForm:"
							+ e.getMessage());
		}
	...
	public void setCountry(String country) {
		...
		supplementaryAddress.setCountry(country);
	}
	...
	public void setCollectoralAmt(String collectoralAmt) {
		...
		//System.out.println("++++++++++++collectoralAmt++++++set+++++++++"+collectoralAmt);
	}
