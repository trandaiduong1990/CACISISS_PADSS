...
function go(action) {
    if(action =="save"){
		 		...
		 		if(!document.forms[0].selectedPinPrintSerialNo.checked){
	     		  ...
	     		  if (r==true)
	     		  {
		     		document.forms[0].method.value=action;
			   		document.forms[0].action ="pinprintingprocess.do";
     ...
     }else
     {
     	...
     	document.forms[0].action ="pinprintinglistpage.do";
...
<body bgcolor="ffffff">
<html:form action ="pinprintinglistpage.do">
        ...
        <tr>
          <td class="titreSection"><table border="0" cellspacing="0" cellpadding="4">
            <tr>
              ...
              <html:button property="pinprint" onclick="go('save')"><bean:message key ="common.pinprint"/></html:button>
              </td>
              <td>&nbsp;</td>
            </tr>
                ...
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      ...
                      <tr>
                        ...
                        <td><html:text property="startDate" size="20" onblur="javascript:isValidDate(document.pinPrintingSearch.startDate)"/></td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="cardpersonalization.enddate"/></td>
                        <td><html:text property="endDate" size="20" onblur="javascript:isValidDate(document.pinPrintingSearch.endDate)"/></td>
                      </tr>
                      <tr>
                               ...
                               <logic:iterate id ="commObj" name ="SEARCHLIST"> 
                                  <tr>
                                    <td class="DataTD" id="firstcolumn" nowrap>
                                        <logic:notEqual name="pinPrintingSearch" property="cardPrintingStatus" value="8">
