...
<html:html>
<head>
<title><bean:message key ="cardcardembossingreplacementsearch.screentitle"/></title>
...
<script language="JavaScript">
    ...
    function report() {
     	 document.forms[0].action="GenerateReportServlet.do?hdOpCode=4&mode=Down&REPORT_CODE=CESRC";
     	document.forms[0].submit();
      }

    function downloadFile() {
    	document.forms[0].action="cardembossingreplacementprocess.do";
...
<body bgcolor="ffffff">
<html:form action ="cardembossingreplacementprocess.do">
 <input type="hidden" name="method" value ="">

<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
<html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>

<bean:define id="cardNums" name="replacementCardEmbossingSearch" property="cardNos"/>
<bean:define id="eFile" name="replacementCardEmbossingSearch" property="emossFile"/>
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardcardembossingreplacementsearch.screentitle"/></td>
        </tr>
        <tr>
    ...
    <td valign="top">
     <br>
      <table width="100%">
        ...
        <tr> 
          <td valign="top">
			<logic:present name="replacementCardEmbossingSearch" property="successCardsList"> 
			<bean:size id="size" name="replacementCardEmbossingSearch" property="successCardsList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="maskedCardNo" name="replacementCardEmbossingSearch" property="successCardsList" class="simple" width="80%">
