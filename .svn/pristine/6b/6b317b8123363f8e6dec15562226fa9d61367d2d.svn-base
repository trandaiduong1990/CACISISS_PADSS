...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Transaction Summary By Card Product"; %>
			<tr class="desc_cell">
					...
					<tr>
						...
						<table>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','TRNXSUMMBYCP','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXSUMMBYCP', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','TRNXSUMMBYCP', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','TRNXSUMMBYCP','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','TRNXSUMMBYCP','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						<td class="texts" nowrap><b> Card Type ID </b></td>
						<td class="texts" nowrap><b> Product Name </b></td>
						<td class="texts" nowrap><b> Card Type Name </b></td>
