...
<script language="JavaScript">
    ...
    function report() {
     	 document.forms[0].action="GenerateReportServlet.do?hdOpCode=4&mode=Down&REPORT_CODE=CDP";
...
<body bgcolor="ffffff">
<html:form action ="carddeliverprocess.do">

<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
<html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>

<bean:define id="cardNums" name="cardDeliverSearch" property="cardNos"/>
    ...
    <td valign="top">
     <br>
      <table width="100%">
        ...
        <tr> 
          <td valign="top">
			<logic:present name="cardDeliverSearch" property="successCardsList"> 
			<bean:size id="size" name="cardDeliverSearch" property="successCardsList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="cardDeliver" name="cardDeliverSearch" property="successCardsList" class="simple" width="80%">
				   ...
				   <display:caption><font class="titreSection"><bean:message key ="carddeliver.successnos"/></font></display:caption>
			   	</display:table>
			</logic:greaterThan>
			</logic:present>
     	  </td>
