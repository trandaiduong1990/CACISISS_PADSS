		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="60%">
					...
					<bean:size id ="size" property="postTranx" name ="cardHolderStatementForm"/>
					...
					<tr>
						...
						<table class="wrapper" border="0" cellspacing="1" cellpadding="2">
							...
							<logic:iterate name="cardHolderStatementForm" property="postTranx" id="TranxDetail">
								<tr>
									...
									<logic:equal value="N" property="column5" name="TranxDetail">
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column3" /></td>
									</logic:equal>
									<logic:equal value="Y" property="column5" name="TranxDetail">
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column6" /></td>
									</logic:equal>
					...
					<bean:size id ="size" property="paymentTranx" name ="cardHolderStatementForm"/>
		        	<logic:greaterThan  name ="size" value ="0"> 
					<tr>
						<td
							style="PADDING-RIGHT: 20px; PADDING-LEFT: 20px; PADDING-TOP: 10px">
					...
					<tr>
						...
						<table class="wrapper" border="0" cellspacing="1" cellpadding="2">
							...
							<logic:iterate name="cardHolderStatementForm" property="paymentTranx" id="TranxDetail">
								<tr>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column1" /></td>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column2" /></td>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column3" /></td>
					...
					<bean:size id ="size" property="feeTranx" name ="cardHolderStatementForm"/>
		        	<logic:greaterThan  name ="size" value ="0"> 
					<tr>
						<td
							style="PADDING-RIGHT: 20px; PADDING-LEFT: 20px; PADDING-TOP: 10px">
					...
					<tr>
						...
						<table class="wrapper" border="0" cellspacing="1" cellpadding="2">
							...
							<logic:iterate name="cardHolderStatementForm" property="feeTranx" id="TranxDetail">
								<tr>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column1" /></td>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column2" /></td>
									<td class="DataTD" nowrap><bean:write name="TranxDetail" property="column3" /></td>
