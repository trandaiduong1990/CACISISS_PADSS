...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Canceled Cards Statistics"; %>
			<tr class="desc_cell">
					...
					<tr>
						...
						<table>
							...
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','CANCELCARDSSTATISTICS','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','CANCELCARDSSTATISTICS', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','CANCELCARDSSTATISTICS', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
