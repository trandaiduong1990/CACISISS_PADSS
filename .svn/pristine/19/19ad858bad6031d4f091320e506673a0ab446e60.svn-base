...
function Calendar(p_item, p_WinCal, p_month, p_year, p_format, p_type) {
	...
	this.gBGColor = "white";
	this.gFGColor = '#99CCFF';
	this.gTextColor = "black";
	this.gHeaderColor = '#99CCFF';
...
Calendar.prototype.show = function() {
	...
	this.wwrite("<TABLE WIDTH='237' BORDER=0 CELLPADDING=0 BGCOLOR='#000033'><TR><TD>" +  
	"<TABLE BORDER=0 WIDTH='100%' CELLPADDING=1 BGCOLOR='#FFFFCC'>" +  
	"<TR><TD BGCOLOR='#99CCFF'>" + 
	"<FONT COLOR='#000033' FACE='" + fontface + "' SIZE=2><B>" + this.gTitle + "</B></FONT>" + 
	"</TD><TD BGCOLOR='#99CCFF' ALIGN=CENTER>" + 
	...
	if (arguments[4] == null)
		...
		p_type = (typeof(arguments[4]) == "string" && 
					(arguments[4] == "POPUP" || arguments[4] == "INLINE")) ?
						...
						"POPUP";
	if (arguments[5] == null)
		p_custom = "CloseOnSelect=Yes;AppendOrReplace=Replace;AppendChar=';';ReturnData=Date;Title=Please Choose a Date;AllowWeekends=Yes;Resizable=No";
	else
		p_custom = typeof(arguments[5]) == "string" ?
					arguments[5]
					:
					"CloseOnSelect=Yes;AppendOrReplace=Replace;AppendChar=';';ReturnData=Date;Title=Please Choose a Date;AllowWeekends=Yes;Resizable=No";
