...
import org.transinfo.cacis.formbean.disputemanagement.DisputeTranxSearchForm;
...
public class DisputeTransactionSearchAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		DisputeTranxSearchForm objForm = (DisputeTranxSearchForm) form;
		...
		// Dto Creation
		DisputeTranxSearchDto objDto = new DisputeTranxSearchDto();
		...
		objDto = objManager.search(objDto, pageNo);
