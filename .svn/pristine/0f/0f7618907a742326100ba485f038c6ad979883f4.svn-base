...
<html:html>
<head>
<title><bean:message key ="chargeback2setup.screentitle"/></title>
...
<body>
 <html:form action="chargeback2process.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="chargeback2setup.screentitle"/></td>
