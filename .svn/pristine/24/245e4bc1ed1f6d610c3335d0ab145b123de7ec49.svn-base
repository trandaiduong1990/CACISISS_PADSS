...
public class TransactionDebitGLDto implements Serializable {
	
	private String tranxDebitGLId;
	...
	public String getTranxDebitGLId() {
		return tranxDebitGLId;
	}
	public void setTranxDebitGLId(String tranxDebitGLId) {
		this.tranxDebitGLId = tranxDebitGLId;
	}
