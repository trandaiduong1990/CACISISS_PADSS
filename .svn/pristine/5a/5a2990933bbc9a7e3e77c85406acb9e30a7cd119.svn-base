...
<html:html>
<head>
<title><bean:message key ="cardproductfeesearch.screentitile"/></title>
...
<script language="JavaScript">
  ...
  function addNew() {
   document.forms[0].action="cardproductfeeprocess.do?method=addNew";
...
<body bgcolor="ffffff">
 ...
 <html:form  action ="cardproductfeelist">
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardproductfeesearch.screentitile"/></td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="cardproductfeesetup.cardproductname"/></td>
   ...
   <display:column property="column1" title="FeeId" class="label" />
   ...
   <display:caption><font class="titreSection">CardProducFee  Setup Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="cardproductfeeprocess.do">	 
