...
<table width="102%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<tr>
				<%String reportName = "";
				if (strReportCode.trim().equals("STL"))
					reportName = "Settlement Report";
				if (strReportCode.trim().equals("CRV"))
					reportName = "Card Volume Report";
				if (strReportCode.trim().equals("TND"))
					reportName = "Transaction Detail Report";
				if (strReportCode.trim().equals("TNL"))
					reportName = "Transaction Listing Report";
					...
					%>
							...
							<tr>
								<td><input type="button"
									onClick="javascript:setmode(0,'Search','TND','frmMain')"
									value="Search" name="Search"> <input type="button"
									onClick="javascript:setmode(4,'View','TND')"
