...
public class PayWaiverManager {

	private PayWaiverDAO objDAO;

	public PayWaiverManager() throws Exception {
		objDAO = DAOFactory.getInstance().getPayWaiverDAO();
	}
	...
	public List getIntTranx(String cardNo) throws TPlusException {
		...
		try {
			...
			feeTranxList = objDAO.getIntTranx(cardNo);
