...
<script language="JavaScript" src="js/ExpireCardReport.js"></script>
...
<table width="102%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<% String reportName = "Expired Card List"; %>
			<tr class="desc_cell">
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<table>
							...
							<tr>
								<td class="desc_cell">Expire Date:</td>
								<td>
									<input type="text" name="EXP_DATE" size="16" maxlength="5" value="<%=strExpireDate%>" class="form_field">
                                	(MM/YY)
								</td>
							</tr>
							<tr>
								<td colspan="2">
								<div align="left">
									<input type="button" onClick="javascript:setmode(0,'Search','EXPIREDCARDLIST','frmMain')" value="Search" name="Search">
									<input type="button" onClick="javascript:setmode(4,'Down','EXPIREDCARDLIST', 0)" value="PDF Download " name="PDF">
									<input type="button" onClick="javascript:setmode(4,'Down','EXPIREDCARDLIST', 2)" value="Excel Download " name="PDF">
								</div>
								</td>
							</tr>
						</table>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-bottom: 10px;">
					<%if (intPage!= 1){%>
		              <input type="button" onClick="javascript:setmode(1,'Search','EXPIREDCARDLIST','frmMain')" value="Previous" name="Search">
		            <%}%>
		            <%if (intPage != intTotal){%>
		              <input type="button" onClick="javascript:setmode(2,'Search','EXPIREDCARDLIST','frmMain')" value="Next" name="Search">
		            <%}%>
				</td>
				<td class="texts" style="padding-bottom: 10px;">
				<% if (intTotalNoOfRecords > 0) { %>
			...
			<tr>
				...
				<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%">
					<tr bgcolor="#CCCCCC">
						...
						<td class="texts" nowrap><b> DOB </b></td>
						<td class="texts" nowrap><b> ID Number </b></td>
