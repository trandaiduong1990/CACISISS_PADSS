...
<html:html>
<head>
<title><bean:message key ="customerservice.creditsplit"/></title>
...
///to call csrDispatchAction to show all the data as popup window
  ...
  function showList(){
    document.forms[0].action ="creditsplitpage.do?method=checkSession";
    document.forms[0].submit();
    
   }
</script>
<body bgcolor="ffffff">
  <html:form action="creditsplitpage.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.creditsplit"/></td>
        </tr>
        <tr>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.creditsplit"/></td>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    ...
                    <div align="right"> 
                          ...
                          <a href ="creditsplitprocess.do?method=creditSplitData&cardNo=<bean:write name ="custServObj"  property="cardNumber" />" ><bean:message key ="common.creditsplit"/> </a>
