...
<html:html>
<head>
<title><bean:message key ="passwordchangesetup.screentitle"/></title>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="passwordchangesetup.screentitle"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
        		     ...
        		     <%if(request.getAttribute("ACTION") == null || ((String)request.getAttribute("ACTION")).equals("update")) { %>
        			  <html:button property="pwchange" onclick="go('update')"><bean:message key ="common.save"/></html:button>
        		     <% }%>		
                        ...
                        <td><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td valign="top" width="242">
                              	<html:text property="userId" value="<%=(String)session.getAttribute("USERID")%>" size="20" readonly="true"/></td>
                              <td>&nbsp;</td>                              
                            </tr>                            
                        </table></td>
                      </tr> 
