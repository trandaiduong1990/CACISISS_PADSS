...
<html:html>
<head>
<title><bean:message key ="loginparameter.screentitle"/></title>
...
<body>
 <html:form action="loginparamprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="loginparameter.screentitle"/></td>
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="loginparameter.grouptitle"/>                        </td>
                ...
                <tr> 
                  ...
                  <td colspan="2" valign="top" class="form_bgcolor" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                    ...
                    <tbody>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="loginparameter.grouptitle"/></td>
                     ...
                     <tr>                                                    
                        <td class="desc_cell" nowrap><b><bean:message key ="loginparameter.pwdexpiryperiod"/></b></td>
                        <td valign="top" width="242"><html:text property="pwdExpiryPeriod" size="20"/></td>                              
                        </tr>                                                    
                      </tr> 
                     <tr>                                                   
                        <td class="desc_cell" nowrap><b><bean:message key ="loginparameter.maxnooffailedattempts"/></b></td>
                        <td valign="top"><html:text property="maxLoginFailed" size="20"/></td>                                                           
                        </tr>                            
                        
                     </tr> 
                     
                      <tr>
                         <td class="desc_cell" nowrap><b><bean:message key ="loginparameter.ftlvaliditydays"/></b></td>
                         <td valign="top"><html:text property="ftlValidityDays" size="20"/></td>
                         </tr>
                      <tr>  
                     <tr> 
		        <td class="desc_cell" nowrap width="100"><b><bean:message key ="loginparameter.lockuser"/></b></td>
		          <td valign="top" width="242">
		      	   <html:select property="lockUser" >
		      	     <html:option value=""></html:option>
		      	     <html:optionsCollection property="optionList" value="key" label="value" />
		      	   </html:select>
		        </td>
                      </tr>                                           
                    </tbody>
