...
public class SystemException extends Exception
{
	...
	*
	*/
	public SystemException(String strErrorCode)
	{
	...
	*
	*/
	public SystemException(String strErrorCode, String strErrMessage)
	{
	...
	*
	*/
	public SystemException(String strErrorCode,String strErrMessage, String strAuxMessage)
	{
		this.strErrorCode  = strErrorCode;
		this.strErrorMessage = strErrMessage;
