...
<html:form action="csrpinresend.do">
  ...
  <html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>
      <html:hidden property="cardNumber" value="<%=(String)session.getAttribute("CARDNUMBER")%>"/>
       ...
       <logic:present name ="cardReplacementForm" scope ="request">
           <html:hidden property="cardStatusId" value="<%=((CardReplacementForm)request.getAttribute("cardReplacementForm")).getCardStatusId()%>"/>
        </logic:present>
          ...
          <tr> 
            <td valign="top" height="323"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                    ...
                    <tbody>   <font color="#FF0000"> <html:errors/> </font>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.pinresend"/></td>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                            ...
                            <tr>
                              <td class="desc_cell" nowrap ><bean:message key ="customerrelation.state"/></td>
                ...
                <tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('pinResendAdd')" > <bean:message key ="common.pinresend"/></html:button></td> 
                  <td background="images/tbl_d.gif"></td>
                </tr>
