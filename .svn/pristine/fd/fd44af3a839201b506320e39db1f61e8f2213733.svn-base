...
<html:form action="csrcardreplacement.do">
          ...
          <tr> 
            <td valign="top" height="323"> 
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                    ...
                    <tbody>  <font color="#FF0000"> <html:errors/> </font>
                        ...
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerrelation.cardreplcement"/> </td>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="100" height="70">
		                    ...
		                    <tr> 
					            <td class="desc_cell" ><b><bean:message key ="customerrelation.reason"/></b></td>
					            <td class="label">
					             <html:select property="reasonCode" >
					                 <html:option value=""></html:option>
					               <logic:greaterThan name = "cardReplacementForm"  property="cardStatusList" value="0" >
					                 <html:optionsCollection  name = "cardReplacementForm"  property="cardStatusList" value="key" label="value" />
					              </logic:greaterThan>
					 	        </html:select>
					      	  </td>
			               </tr>
                ...
                <tr>
                  <td background="images/tbl_g.gif"></td>
                  <td colspan="2" valign="top" class="form_bgcolor"><html:button property="submitbutton" onclick="go('add')" > <bean:message key ="common.replace"/></html:button></td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
