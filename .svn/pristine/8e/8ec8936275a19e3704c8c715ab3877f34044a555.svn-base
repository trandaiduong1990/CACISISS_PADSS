...
public class ApplicationException extends Exception
{
	...
	*
	*/
	public ApplicationException(String strErrorCode, String strErrMessage)
	{
	...
	*
	*/
	public ApplicationException(String strErrorCode,String strErrMessage, String strAuxMessage)
	{
		this.strErrorCode  = strErrorCode;
		this.strErrorMessage = strErrMessage;
