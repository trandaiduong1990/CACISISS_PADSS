...
import org.transinfo.cacis.formbean.customerservice.TranxEnquirySearchForm;
...
public class AddProductSearchAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				...
				AddProductSearchForm objForm = (AddProductSearchForm) form;
				AddProductSearchForm newObjForm = new AddProductSearchForm();
			...
			// Dto Creation
			AddProductSearchDto objDto = new AddProductSearchDto();
	
			try {
				BeanUtils.copyProperties(objDto, objForm);
			} catch (Exception e) {
				throw new TPlusException(
						"In AddProductSearchAction executeAction: " + e);
			}
	
			// Action execution
			AddProductManager objAddProductManager = new AddProductManager();
			objDto = objAddProductManager.search(objDto, pageNo);
