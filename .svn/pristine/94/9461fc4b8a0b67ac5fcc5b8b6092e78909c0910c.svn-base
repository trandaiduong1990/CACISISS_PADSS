...
<html:html>
<head>
<title><bean:message key ="customerservice.crscreentitle"/></title>
...
<body bgcolor="ffffff">
<html:form  action ="cardrenewalpage" >
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.crscreentitle"/></td>
        </tr>
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157" align="left">
                ...
                <td class="texteMenuGauche"> 
                  <html:button property="submitbutton" onclick="go('searchRenewal')" ><bean:message key ="common.search"/></html:button> 
                 </td>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$"> 
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.crscreentitle"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
					   ...
					   if(request.getAttribute("ACTION") == null || ((String)request.getAttribute("ACTION")).equals("search")) {%>
                         ...
                         <html:button property="submitbutton" onclick="showList('cardrenewalpage.do?method=checkSession')"><bean:message key ="common.cancel"/></html:button>
       		         ...
       		         <% }else if(((String)request.getAttribute("ACTION")).equals("replace")) { %>
       					 ...
       					 <html:button property="submitbutton" onclick="showList('cardrenewalprocesslist.do?method=checkSession')"><bean:message key ="common.cancel"/></html:button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                           <!-- if action =search then dipalying the billing addres in text fields to edit the addressfields of cardRenewalForm bean  and showing add and cancel buttons-->
					    ...
					    {%>
					       <tr> 
                               ...
                               <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.address1" /></td>
                            </tr>
							<tr> 
                              <td class="desc_cell" nowrap ><bean:message key ="customerservice.address2"/></td>
                             <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.address2" /></td>
                            </tr>
							...
							<tr> 
                              ...
                              <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.state" /></td>
                            </tr>
                             <tr> 
                               <td class="desc_cell" nowrap ><bean:message key ="customerservice.city"/></td>
                               <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.city" /></td>
                            </tr>
                            <tr> 
                                <td class="desc_cell" nowrap ><bean:message key ="customerservice.township"/></td>
                                <td class="label"><bean:write name ="cardRenewalForm"    property="requestAddress.township"/></td>
                            </tr>
                             <tr> 
                                  <td class="desc_cell" nowrap ><bean:message key ="customerservice.postalcode"/></td>
                                  <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.postalCode" /></td>
                            </tr>
							<tr>
							     <td class="desc_cell" nowrap ><bean:message key ="customerservice.phone"/></td>
							     <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.phone" /></td>
                            </tr>
                            <tr> 
                                <td class="desc_cell" nowrap ><bean:message key ="customerservice.fax"/></td>
                                <td class="label"><bean:write name ="cardRenewalForm"  property="requestAddress.fax" /></td>
							</tr>
					      <!--<tr> 
