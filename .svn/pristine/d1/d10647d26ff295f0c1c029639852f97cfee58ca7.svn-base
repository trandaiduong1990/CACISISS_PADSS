              ...
              <table border="0" cellpadding="0" cellspacing="0" align="left">
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right">
                    <logic:equal value="R" property="statusSymbol" name="chargeBackResendSetupForm">
      					<html:button property="submitbutton" onclick="go('chargeBackClose')" ><bean:message key ="common.close"/></html:button>
      					<html:button property="submitbutton" onclick="go('chargeBackCorrection')" ><bean:message key ="common.correction"/></html:button>
      				</logic:equal>
                    ...
                    <tr>
                      ...
                      <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                          ...
                          <tr>
                            <td height="59">
                            <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;width: 300px;" bordercolor="#111111">
                              <tr>
                                <td nowrap class="desc_cell"><bean:message key ="disputemanagement.cb.view.arn"/></td>
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="disArn" /></td>
                              </tr>
                              <tr>
                                <td nowrap class="desc_cell"><bean:message key ="disputemanagement.cb.view.disamt"/></td>
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="disAmt" /></td>
                              </tr>
                              <tr>
                                <td nowrap class="desc_cell"><bean:message key ="disputemanagement.cb.view.curr"/></td>
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="disCurr" /></td>
                              </tr>
                              <tr>
                                <td nowrap class="desc_cell"><bean:message key ="disputemanagement.cb.view.cardholder"/></td>
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="cardHolder" /></td>
                              </tr>
                              <tr>
                                <td nowrap class="desc_cell"><bean:message key ="disputemanagement.cb.view.reason"/></td>
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="disReason" /> </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="label"><bean:write name="chargeBackResendSetupForm" property="memMsgText" /></td>
                              </tr>
                            </table>
                            </td>
                          </tr>
