...
public class SearchChargeBack2Action extends BaseDispatchAction {
	...
	public void commonSearch(int pageNo, OriginalRequestSearch objForm,
		...
		if (!exist) {
			...
			Collection ChargeBack2 = objManager.search(objDto, pageNo);
			request.setAttribute("SEARCHLIST", ChargeBack2);
		}
		request.setAttribute("PAGENO", new Integer(pageNo).toString());
		System.out.println("ChargeBack2Action: execute() successful");
	}
}