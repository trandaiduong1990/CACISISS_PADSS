...
<html:html>
<head>
<title><bean:message key ="customerservice.pinresend"/></title>
...
<body bgcolor="ffffff">
 <html:form action="pinresendlist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.pinresend"/></td>
        </tr>
         ...
         <html:hidden property="customerId"/>
          ...
          <html:hidden property="cardProductId" /> 
           <html:hidden property="cardHolderType"/>  
            <html:hidden property="cardStatusId"/> 
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$"> 
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.pinresend"/></td>
              ...
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <%
 			      ...
 			      <html:button property="submitbutton" onclick="go('pinResendAdd')"><bean:message key ="common.save"/></html:button>
 			      <html:button property="submitbutton" onclick="showList('pinresendlist.do?method=checkSession')"><bean:message key ="common.cancel"/></html:button>
        	     <% }else if(((String)request.getAttribute("ACTION")).equals("pinresend"))	
        				    { %>
                    <html:button property="accept" onclick="accRej('pinResendAccept')"><bean:message key ="common.accept"/></html:button>
                	<html:button property="accept" onclick="accRej('pinResendReject')"><bean:message key ="common.reject"/></html:button>
                	<html:button property="submitbutton" onclick="showList('pinresendprocess.do?method=pinResendProcessSearch')"><bean:message key ="common.cancel"/></html:button>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                            <tr> 
                                 ...
                                 <td class="label"><bean:write name ="pinResendForm"  property="requestAddress.address1" /></td>
                            </tr>
							<tr> 
                                <td class="desc_cell" nowrap ><bean:message key ="customerservice.address2"/></td>
                                <td class="label"><bean:write name ="pinResendForm"  property="requestAddress.address2" /></td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              ...
                              <td class="label"><bean:write name ="pinResendForm"  property="requestAddress.postalCode"/></td>
                            </tr>
							<tr>
							   <td class="desc_cell"><bean:message key ="customerservice.phone"/></td>
							   <td class="label"><bean:write name ="pinResendForm"  property="requestAddress.phone"  /></td>
                            </tr>
                            <tr> 
                                <td class="desc_cell"><bean:message key ="customerservice.fax"/></td>
                                <td class="label"><bean:write name ="pinResendForm"   property="requestAddress.fax"/></td>
							</tr>
                          ...
                          <tr>
                            ...
                            <tbody>
                              <tr>
                                <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerservice.resendfees"/></td>
                                <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                              </tr>
                            </tbody>
                        	</table>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
 			      ...
 			      <html:button property="submitbutton" onclick="go('pinResendAdd')"><bean:message key ="common.save"/></html:button>
 			      <html:button property="submitbutton" onclick="showList('pinresendlist.do?method=pinResendProcessSearch')"><bean:message key ="common.cancel"/></html:button>
 			      
        	     <% }else if(((String)request.getAttribute("ACTION")).equals("pinresend"))	
        				    { %>
                    <html:button property="submitbutton" onclick="go('pinResendAccept')"><bean:message key ="common.accept"/></html:button>
                	<html:button property="submitbutton" onclick="go('pinResendReject')"><bean:message key ="common.reject"/></html:button>
                 	<html:button property="submitbutton" onclick="showList('pinresendprocess.do?method=pinResendProcessSearch')"><bean:message key ="common.cancel"/></html:button>
        	     <%}else if(((String)request.getAttribute("ACTION")).equals("cancel")){%>
          	           <html:button property="submitbutton" onclick="showList('pinresendprocess.do?method=pinResendProcessSearch')"><bean:message key ="common.cancel"/></html:button>
         	      <%} %>
