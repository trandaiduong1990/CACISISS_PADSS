...
<html:html>
<head>
<title><bean:message key ="customerservice.resetpincount"/></title>
...
///to call csrDispatchAction to show all the data as popup window
  ...
  function showList(){
    document.forms[0].action ="resetpincountprocess.do?method=checkSession";
    document.forms[0].submit();
    
   }

  function resetPIN(method) 
  {
    document.forms[0].method.value=method;
    var r=confirm("<bean:message key ='areyousuretoresetpin'/>");
    if (r==true)
    {
  	document.forms[0].submit();
    }
...
<body bgcolor="ffffff">
   ...
   <html:form action="resetpincountprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.resetpincount"/></td>
        </tr>
        <tr>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.resetpincount"/></td>
              ...
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
                        ...
                        <html:button property="submitbutton" onclick="resetPIN('resetpincount')" > <bean:message key ="common.resetpincount"/></html:button>
                      ...
                      <tr>
                        <td height="96"><table border="0" cellpadding="0" cellspacing="0" width="264" height="96">
							...
							<tr> 
                             ...
                             <tr> 
                               <td class="desc_cell" nowrap ><bean:message key ="customerservice.resetpincount"/></td>
                              <td class="label"><bean:write name ="custServObj"  property="wrongPinCount" /></td>
                            </tr> 
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                           ...
                           <tr> 
                               ...
                               <td class="label"><html:textarea  property="remarks" rows="3" value="" ></html:textarea>
                          </tr>        -->   
                        </table></td>
                      </tr>
                    </tbody>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    ...
                    <html:button property="submitbutton" onclick="go('resetpincount')" > <bean:message key ="common.resetpincount"/></html:button>
                   <html:button property="submitbutton" onclick="showList()"><bean:message key ="common.cancel"/></html:button>
                    </div>				  </td>
                  <td background="images/tbl_d.gif"></td>
                </tr>
