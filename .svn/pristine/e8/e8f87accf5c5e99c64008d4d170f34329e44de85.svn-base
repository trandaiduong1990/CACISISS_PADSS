...
<html:html>
<head>
<title><bean:message key ="customerservice.cardreceived"/></title>
...
///to call csrDispatchAction to show all the data as popup window
  ...
  function showList(){
    document.forms[0].action ="cardreceivedprocess.do?method=checkSession";
    document.forms[0].submit();
    
   }
</script>
<body bgcolor="ffffff">
 <html:form action="cardreceivedprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.cardreceived"/></td>
        </tr>
        <tr>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.cardreceived"/></td>
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
                       ...
                       <html:button property="submitbutton" onclick="go('cardreceived')" > <bean:message key ="common.confirm"/></html:button>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
						   ...
						   <tr> 
                               ...
                               <td class="label"><bean:write name ="custServObj" property="remarks" /></td>
                          </tr>
