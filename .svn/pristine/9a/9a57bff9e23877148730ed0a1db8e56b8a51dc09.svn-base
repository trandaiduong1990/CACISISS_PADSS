...
public class TransactionEnquirySearchAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				...
				TranxEnquirySearchForm objForm = (TranxEnquirySearchForm) form;
				TranxEnquirySearchForm newObjForm = new TranxEnquirySearchForm();
			...
			// Dto Creation
			TranxEnquirySearchDto objDto = new TranxEnquirySearchDto();
