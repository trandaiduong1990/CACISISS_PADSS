...
<script language="JavaScript">
    ...
    function batchProcess() {
    	  ...
    	  if (r==true)
    	  {
    	    document.forms[0].action="replacementcardbatchprocess.do?method=process";
    		document.forms[0].submit();
    	  }
      }

    function go(param) {
        document.forms[0].action="replacementcardbatchprocess.do?method=List";
...
<body bgcolor="ffffff" onload="Func1Delay()">
        ...
        <tr>
          <td class="titreSection">
              ...
              <tr> 
                ...
                <logic:present name="replacementCardBatchprocessFrom" property="appList"> 
					<bean:size id="size" name="replacementCardBatchprocessFrom" property="appList"/>
      ...
      <table width="100%">
          ...
          <td valign="top">
          	<table>
          		...
          		<tr>
          			...
          			<td>
          				<bean:write name ="replacementCardBatchprocessFrom" property="totalNoOfApps" />
          			</td>
          		</tr>
          	</table>
          </td>
        ...
        <tr> 
          <td valign="top">
			   ...
			   <display:table  id="appProcess" name="replacementCardBatchprocessFrom" property="appList" class="simple" width="80%">
				   ...
				   <display:column property="column6" title="Card Number" class="label" />
				   <display:column property="column4" title="Reason" class="label" />
				   <display:column property="column5" title="Applied Date" class="label" />
				   <display:caption><font class="titreSection">Replacement Cards Batch Process Records</font></display:caption>
			   </display:table>
     	  </td>
        </tr>
  		<tr> 
