...
import org.transinfo.cacis.formbean.disputemanagement.ChargebackSearchForm;
...
public class ChargeBackSearchAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		ChargebackSearchForm objForm = (ChargebackSearchForm) form;
		...
		// Dto Creation
		ChargeBackSearchDto objDto = new ChargeBackSearchDto();
		...
		objDto = objManager.CBsearch(objDto, pageNo);
