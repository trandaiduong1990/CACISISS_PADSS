...
<script language="JavaScript">
    ...
    function report() {
     	 document.forms[0].action="GenerateReportServlet.do?hdOpCode=4&mode=Down&REPORT_CODE=CPM";
...
<body bgcolor="ffffff">
<html:form action ="pinprintingprocess.do">

<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
<html:hidden property="userId" value="<%=(String)session.getAttribute("USERID")%>"/>

<bean:define id="cardNums" name="pinPrintingSearch" property="cardNos"/>
    ...
    <td valign="top">
     <br>
      <table width="100%">
        ...
        <tr> 
          <td valign="top">
			<logic:present name="pinPrintingSearch" property="successCardsList"> 
			<bean:size id="size" name="pinPrintingSearch" property="successCardsList"/>
			<logic:greaterThan name="size" value="0" >
				<display:table id="cardPINMail" name="pinPrintingSearch" property="successCardsList" class="simple" width="80%">
