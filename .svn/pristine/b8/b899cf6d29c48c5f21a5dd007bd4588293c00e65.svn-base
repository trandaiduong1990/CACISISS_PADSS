...
import org.transinfo.cacis.controller.disputemanagement.DisputeConfigManager;
import org.transinfo.cacis.dto.disputemanagement.DisputeConfigMasterDto;
import org.transinfo.cacis.formbean.disputemanagement.DisputeConfigForm;

public class DisputeConfigDispatchAction extends BaseDispatchAction {
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
		...
		DisputeConfigManager objManager = new DisputeConfigManager();
		DisputeConfigMasterDto objDto = new DisputeConfigMasterDto();
		DisputeConfigForm objForm = (DisputeConfigForm) form;
	...
	public ActionForward update(ActionMapping mapping, ActionForm form,
		...
		if (!boolUpdate) {
			System.out.println("DisputeConfigDispatchAction: update record fail");
			errors = new ActionErrors();
		...
		System.out.println("DisputeConfigDispatchAction:update() successful");
		// Success
		resetToken(request);
		request.setAttribute("ACTION", "change");
		return mapping.findForward("success");
