...
<html:html>
<head>
<title><bean:message key ="customerservice.billingaddchange"/></title>
...
<script language="JavaScript" src="inc/js/BillingAddress.js"></script>
</head>
<script>
function go(method) 
{
...
///to call csrDispatchAction to show all the data as popup window
  ...
  function showList(){
    document.forms[0].action ="billingaddprocess.do?method=checkSession";
    
   }

  function countryUpdate(country, type) {

    	//var  country = dwr.util.getValue("requestAddress.country");
    	//alert(country.value);
    	stateUpdate(country.value, type);
    	
  }
</script>
<body bgcolor="ffffff">
  <html:form action="billingaddprocess.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="customerservice.billingaddchange"/></td>
        </tr>
        <tr>
          ...
          <td class="titreSection">
              <table border="0" cellspacing="2" cellpadding="2" width="157" align="left">
                ...
                <td class="texteMenuGauche"> 
                  <html:submit onclick="go('search')" ><bean:message key ="common.search"/></html:submit> 
                 </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr> 
                        <td> <font class="label"><b><bean:message key ="customerservice.cardnumber"/></b></font> 
                          <html:text property="cardNumber" maxlength ="16" size="20"/>
  ...
  <logic:iterate id ="custServObj" name ="$CARDREPLACELIST$">
    ...
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="customerservice.billingaddchange"/></td>
        ...
        <tr> 
          <td width="482" valign="top"> 
              <table width="482" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td class="form_bgcolor"  colspan="2"> 
                    <div align="right"> 
                          ...
                          <html:submit onclick="go('billingaddchange')" ><bean:message key ="common.change"/></html:submit>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td height="21"><table border="0" cellpadding="0" cellspacing="0" width="264" height="72">
				             ...
				             <tr> 
				                 <td class="desc_cell" nowrap width="132" height="18"><bean:message key ="customerservice.adressemail"/></td>
				                 <td class="label"><bean:write name ="custServObj"  property="email" /></td>
				             </tr>  
                      ...
                      <tr>
                        <td width="335"><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerservice.currentaddress"/></td>
                                <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                              </tr>
                            </tbody>
                        </table></td>
                ...
                <!-- this for setting the new billing address --> 
                    ...
                    <tbody>
                      <tr>
                        <td><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                <td><img height=19 alt="" src="images/tab_g.gif" width=8 border=0></td>
                                <td class=group_title background=images/tab_fond.gif><bean:message key ="customerservice.newaddress"/></td>
                                <td><img height=19 alt="" src="images/tab_d.gif" width=8 border=0></td>
                              </tr>
                            </tbody>
                        </table></td>
                      ...
                      <tr>
                        <td height="109"><table border="0" cellpadding="0" cellspacing="0" width="264" height="109">
                            <tr> 
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.address1"/></td>
                              <td class="label"><html:text  property="requestAddress.address1" size="20" value=""/></td>
                            </tr>
							<tr> 
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.address2"/></td>
                              <td class="label"><html:text   property="requestAddress.address2" size="20" value=""/></td>
                            </tr>
                            <tr> 
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.country"/></td>
                              <td class="label">
                             	<html:select property="requestAddress.country" onchange="countryUpdate(this,'request')">
							   	  <html:option value=""></html:option>	
							      <html:optionsCollection property="countryList" value="key" label="value" />
							    </html:select>
							    </td>
							...
							<tr> 
                              <td class="desc_cell"><bean:message key ="customerservice.state"/></td>
                             <td class="label">
                             	<div id="request_stateText">
	                                <logic:equal name="cardReplacementForm" property="requestAddress.country" value="MM">
								   	    <html:select property="requestAddress.state" onchange="updateCity(this,'request')">
									   	    <html:option value=""></html:option>	
									      	<html:optionsCollection property="stateList" value="key" label="value" />
									    </html:select>
									</logic:equal>
									<logic:notEqual  name="cardReplacementForm" property="requestAddress.country" value="MM">
	                                	<html:text property="requestAddress.state" size="20" maxlength="20" value=""/>
									</logic:notEqual >
	                            </div>
                            </tr>
                            <tr> 
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.city"/></td>
                              <td class="label">
                              <div id="request_cityText">
                              <logic:equal name="cardReplacementForm" property="requestAddress.country" value="MM">
						   	    <html:select property="requestAddress.city" onchange="updateTownship(this, 'request')">
							   	    <html:option value=""></html:option>	
							      	<html:optionsCollection property="cityList" value="key" label="value" />
							    </html:select>
							  </logic:equal>
							  <logic:notEqual  name="cardReplacementForm" property="requestAddress.country" value="MM">
                              	<html:text property="requestAddress.city" size="20" maxlength="20" value=""/>
							  </logic:notEqual >
                              </div>
                            </tr> 
                            <tr>
                              <td class="desc_cell" nowrap><bean:message key ="customerservice.township"/></td>
                              <td class="label">
                              	<div id="request_townshipText">
                              		<logic:equal name="cardReplacementForm" property="requestAddress.country" value="MM">
							   	    <html:select property="requestAddress.township" >
								   	    <html:option value=""></html:option>	
								      	<html:optionsCollection property="townshipList" value="key" label="value" />
								    </html:select>
									</logic:equal>
									<logic:notEqual  name="cardReplacementForm" property="requestAddress.country" value="MM">
				                    	<html:text property="requestAddress.township" size="20" maxlength="20" value=""/>
									</logic:notEqual >
                              	</div>
                              </td>
                             </tr>
                             <tr> 
                              ...
                              <td class="label"><html:text  property="requestAddress.postalCode" size="20" value="" /></td>
                            </tr>
							<tr>
							   <td class="desc_cell"><bean:message key ="customerservice.phone"/></td>
							   <td class="label"><html:text property="requestAddress.phone" size="20" value=""/></td>
                            </tr>
                            <tr> 
                                <td class="desc_cell"><bean:message key ="customerservice.fax"/></td>
                                <td class="label"><html:text  property="requestAddress.fax" size="20" value=""/></td>
							</tr>
                        </table></td>
                       </tr>                             
                 </tbody>
