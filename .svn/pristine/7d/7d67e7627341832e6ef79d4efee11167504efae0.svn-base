...
<html:html>
<head>
<title><bean:message key ="cardproductlimitsearch.screentitile"/></title>
...
<script language="JavaScript">
    ...
    function addNew() {
       ...
       document.forms[0].action="cardproductlimitprocess.do?method=addNew";
...
<body bgcolor="ffffff">
 ...
 <html:form  action ="/cardproductlimitlist">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="cardproductlimitsearch.screentitile"/></td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="cardproductlimitsetup.cardproductname"/></td>
                        <td> 
   ...
   <br><logic:present name="SEARCHLIST" scope="request">
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="80%">
   		<display:column property="column1" title="Card Product Id" class="label" />
   		<display:column property="column4" title="Card Product Name" class="label" />
   		<display:column property="column2" title="Applicable Salary" class="label" />
    	<display:column property="column3" title="Updated Date" class="label" />
   <display:caption><font class="titreSection">Card Product Limit Setup Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="cardproductlimitprocess.do">	 
