...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="delinquencypolicyprocess.do?method=addNew";
...
<html:form action ="delinquencypolicylist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="co.policySearchTitle"/></td>
        </tr>
        <tr>
...
<div style="margin-top: 10px; margin-bottom: -12px;"><%@ include
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="70%">
	   	<display:column property="column1" title="Policy Id" class="label" />
	   	<display:column property="column2" title="Policy Name" class="label" />
	   	<display:column property="column3" title="Updated Date" class="label" />
	   	<font class="label"><display:column title="" align="center" width="80" ></font>
			<form name ="listForm" action="delinquencypolicyprocess.do">
