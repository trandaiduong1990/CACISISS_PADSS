...
function go(action) {
    if(action =="save"){
     ...
     }else
     {
     	...
     	document.forms[0].action ="cardembossingrenewallistpage.do";
...
<body bgcolor="ffffff">
<html:form action ="cardembossingrenewallistpage.do">
                ...
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      ...
                      <tr>
                        ...
                        <td><html:text property="startDate" size="20" onblur="javascript:isValidDate(document.renewalCardEmbossingSearch.startDate)"/></td>
                      </tr>
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="cardpersonalization.enddate"/></td>
                        <td><html:text property="endDate" size="20" onblur="javascript:isValidDate(document.renewalCardEmbossingSearch.endDate)"/></td>
                      </tr>
                      <tr>
	                       ...
	                       <td colspan="5" nowrap class="title"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	                               ...
	                               <logic:iterate id ="commObj" name ="SEARCHLIST"> 
	                                  <tr>
	                                    ...
	                                    <logic:notEqual name="renewalCardEmbossingSearch" property="cardEmbossingStaus" value="6">
