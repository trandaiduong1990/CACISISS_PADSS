...
<script language="JavaScript">
   ...
   function loadCountry() {
		...
		var table = document.getElementById("applvalidationtable");  
			...
			var row = table.rows[i];
 		   	var chkboxSelect = row.cells[0].getElementsByTagName('select')[0];
 		   	var chkboxSelect1 = row.cells[6].getElementsByTagName('select')[0];
 		   	var slCoutry1 = row.cells[2].getElementsByTagName('select')[0];
 		   	var slText1 = row.cells[2].getElementsByTagName('input')[0];
 		   	var slCoutry2 = row.cells[8].getElementsByTagName('select')[0];
		   	var slText2 = row.cells[8].getElementsByTagName('input')[0];
 		   	
 		   	if(chkboxSelect.options[chkboxSelect.selectedIndex].value == 'NATIONALITY' ) {
 		   		slCoutry1.style.display = "block";
 		   		slText1.style.display = "none";
 		   		
 		   		var name = slText1.getAttribute('name');
 		   		if (name != null && name != '') {
	 		   		slText1.setAttribute('name', '');
	 		   		slCoutry1.setAttribute('name', name);
 		   		}
            } else {
            	slCoutry1.style.display = "none";
 		   		slText1.style.display = "block";
 		   		var name = slCoutry1.getAttribute('name');
 		   		if (name != null && name != '') {
	 		   		slCoutry1.setAttribute('name', '');
	 		   		slText1.setAttribute('name', name);
	 		   		//slText1.value = "";
 		   		}
            }
 		   	
 		   if(chkboxSelect1.options[chkboxSelect1.selectedIndex].value == 'NATIONALITY' ) {
		   		slCoutry2.style.display = "block";
		   		slText2.style.display = "none";
		   		
		   		var name = slText2.getAttribute('name');
		   		if (name != null && name != '') {
		   			slText2.setAttribute('name', '');
			   		slCoutry2.setAttribute('name', name);
		   		}
		   		
           } else {
           		slCoutry2.style.display = "none";
		   		slText2.style.display = "block";
		   		var name = slCoutry2.getAttribute('name');
		   		
		   		if (name != null && name != '') {
			   		slCoutry2.setAttribute('name', '');
			   		slText2.setAttribute('name', name);
			   		//slText2.value = "";
		   		}
           }
 	   	}
...
<body bgcolor="ffffff" onLoad="loadCountry()">
							...
							<table border="0" cellspacing="0" cellpadding="0">
                        		...
                        		<tr>
                        			<td style="padding: 20px 20px 10px 20px;" valign="top">
                        				<table border="0" cellpadding="0" cellspacing="2" id="applvalidationtable">
                        					<tr>
                        					...
                        					<tr>
                        						<td>
                        							<html:select property="criteria${i}" styleClass="criteria" onchange="loadCountry()" style="width:80px;">
	                        					...
	                        					<td>
	                        						...
	                        						<html:select property="value1${i}" style="width:75px; display:none;" styleClass="country1" >
					                              	  <%-- <html:option value=""> </html:option> --%>		
	                        					...
	                        					<td>
	                        						<html:select property="condCriteria${i}" style="width:80px;" onchange="loadCountry()" >
					                              	  <html:option value=""> </html:option>		
													  <html:optionsCollection property="criteriaList" value="key" label="value" />
													</html:select>
												</td>
	                        					...
	                        					<td>
	                        						...
	                        						<html:select property="value${i}" style="width:75px; display:none;" styleClass="country2" >
					                              	  <%-- <html:option value=""> </html:option>	 --%>	
													  <html:optionsCollection property="countryList" value="key" label="value" />
													</html:select>
	                        					</td>
