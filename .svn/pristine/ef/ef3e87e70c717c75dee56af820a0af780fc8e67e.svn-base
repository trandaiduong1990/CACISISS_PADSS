		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="2" width="157">
					<html:form action="cardholderlimitadjustmentlist">
						...
						<tr>
							...
							</html:button> &nbsp;&nbsp;<html:button property="submitbutton" onclick="go('create')">
								<bean:message key="common.create" />
							</html:button></p>
							</td>
						</tr>
				</table>
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td><font class="label"><bean:message
									key="cardholderlimitadjustmentsetup.cardnumber" /></font> <html:text
				...
				<br><logic:present name="SEARCHLIST" scope="request">
					<display:table id="appProcess" name="requestScope.SEARCHLIST"
						...
						<display:column property="column1"
							titleKey="cardholderlimitadjustmentsetup.column1" class="label" />
						<display:column property="column2"
							titleKey="cardholderlimitadjustmentsetup.column2" class="label" />
						<display:column property="column3"
							titleKey="cardholderlimitadjustmentsetup.column3" class="label" />
						<display:column property="column4"
							titleKey="cardholderlimitadjustmentsetup.column4" class="label" />
						<display:column titleKey="cardholderlimitadjustmentsetup.details"
							align="center" width="80">

							<form name="listForm"
								action="cardholderlimitadjustmentprocess.do">
