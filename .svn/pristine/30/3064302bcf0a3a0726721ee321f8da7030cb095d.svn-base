...
public class DelinquencyNotificationSearchForm extends ValidatorForm {
	...
	public void getPreListData() {
		...
		try {
			DelinquencyNotificationSetupDAO objDAO = DAOFactory.getInstance()
					.getDelinquencyNotificationSetupDAO();
