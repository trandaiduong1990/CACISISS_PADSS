...
<html:html>
<head>
<title><bean:message key ="curraratesearch.screentitle"/></title>
...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action= "currencyrateprocess.do?method=addNew";
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="curraratesearch.screentitle"/> </td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr>
                        <td nowrap class="ColumnFONT"><bean:message key ="curraratesetup.currency"/></td>
                        <td> 
   ...
   <display:column property="column1" title="Currency Code" class="label" />
   <display:column property="column2" title="Currency Symbol" class="label" />
   <display:column property="column3" title="Currency Name" class="label" />
    <display:column property="column5" title="Rate" class="label" />
    <display:column property="column4" title="Updated Date" class="label" />
   <display:caption><font class="titreSection">Currency Rate Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="currencyrateprocess.do">	 
	
            <html:hidden property="currencyId" value="<%= ((CommonDataBean)pageContext.getAttribute("commonObj")).getColumn1()%>" />
			<html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
