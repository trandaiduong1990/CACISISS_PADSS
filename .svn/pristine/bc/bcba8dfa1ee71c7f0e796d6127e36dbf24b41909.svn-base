...
public class ListIssuedCards implements ReportUtil {
	...
	public StringBuffer getReportFields() {
		...
		sbfStr.append("CU.ID_NUMBER, CA.CARDNUMBER, CP.CARDPRODUCTNAME, ");
		sbfStr.append("TO_CHAR(CA.EFFECTIVEDATE, 'DD/MM/YYYY') AS ISSUEDATE, CA.EXPDATE, CAS.DESCRIPTION ");
