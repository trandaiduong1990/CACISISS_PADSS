...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="emvprofileprocess.do?method=addNew";
...
<html:form action ="emvprofilelist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="emvprofile.titlesearch"/></td>
        </tr>
        <tr>
  ...
  <tr>
              ...
              <tr> 
                <td> 
                    <table cellpadding="0" cellspacing="4">
                      <tr> 
                        <td class="ColumnFONT"><bean:message key ="emvprofile.name"/></td>
                        <td> 
                        	<html:select property="emvProfileName" >
                        		<html:option value=""> </html:option>	
					         	<html:optionsCollection property="emvProfileNameList" value="key" label="value" />
					        </html:select>
                        </td>
                        <td style="width: 30px;"></td>
                        <td class="ColumnFONT"><bean:message key ="emvprofile.apptype"/></td>
                        <td> 
                        	<html:select property="applType" >
                        		<html:option value=""> </html:option>	
   ...
   <br><logic:present name="SEARCHLIST" scope="request">
    ...
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="70%">
	   	<display:column property="column1" title="EMV Profile Name" class="label" />
	   	<display:column property="column2" title="Appl Type" class="label" />
	   	<display:column property="column3" title="Appl Crypto" class="label" />
	    <display:column property="column4" title="Issuer Author" class="label" />
	   	<display:caption><font class="titreSection">EMV Profile Records</font></display:caption>
	   	<font class="label"><display:column title="Edit" align="center" width="80" ></font>
			<form name ="listForm" action="emvprofileprocess.do">
