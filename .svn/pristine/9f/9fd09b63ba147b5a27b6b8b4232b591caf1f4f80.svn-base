...
public class SearchOriginalRequestAction extends BaseDispatchAction {
	...
	public void commonSearch(int pageNo, OriginalRequestSearch objForm,
		...
		if (!exist) {
			...
			Collection OriginalRequest = objManager.search(objDto, pageNo);
			request.setAttribute("SEARCHLIST", OriginalRequest);
		}
		request.setAttribute("PAGENO", new Integer(pageNo).toString());
		System.out.println("OriginalRequestAction: execute() successful");
	}
