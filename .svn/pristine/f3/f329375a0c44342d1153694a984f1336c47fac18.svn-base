...
<html:html>
<head>
<title><bean:message key ="applicationprocesssearch.screentitle"/></title>
...
function go(action) {
	document.forms[0].mode.value=action;
 	document.forms[0].action ="applicationprocesslist.do";
	document.forms[0].submit();
}
</script>
</head>
...
<body bgcolor="ffffff">
 <html:form  action ="applicationprocesslist">
 ...
 <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="applicationprocesssearch.screentitle"/></td>
        </tr>
        <tr>
  ...
  <br><logic:present name="SEARCHLIST" scope="request">
   ...
   <display:column property="column1" title="ApplicationId" class="label" />
    ...
    <display:caption><font class="titreSection">ApplicationFormProcess Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	  <form name ="listForm" action="appprocess.do">	 
