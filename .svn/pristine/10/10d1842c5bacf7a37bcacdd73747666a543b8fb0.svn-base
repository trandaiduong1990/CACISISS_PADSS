...
<html:html>
<head>
<title><bean:message key ="risktransxperiodsetup.screentitle"/></title>
...
function showList()
{ 
 document.forms[0].action="risktranxperiodlist.do";
 document.forms[0].submit();
}

function addNew()
{ 
 document.forms[0].action="risktranxperiodprocess.do?method=addNew";
 document.forms[0].submit();
}
</script>
<body>
 <html:form action="risktranxperiodprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="519"><bean:message key ="risktransxperiodsetup.screentitle"/></td>
                  ...
                  <td background="images/tbl_haut.gif" colspan="2"> 
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<bean:message key ="risktranxperiodsetup.grouptitle"/>                      </td>
                ...
                <tr> 
                  ...
                  <td colspan="2" valign="top" class="form_bgcolor" style="padding: 20px 20px 10px 20px;"><table cellspacing=0 cellpadding=0 
                    ...
                    <tbody>
                        ...
                        <td colspan=2><table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                              <tr>
                                ...
                                <td nowrap class=group_title background=images/tab_fond.gif><bean:message key ="risktranxperiodsetup.grouptitle"/></td>
                     ...
                     <tr>                                                    
                        <td class="desc_cell" nowrap><b><bean:message key ="risktranxperiodsetup.duration"/></b></td>
                        <td valign="top" width="242"><html:text property="period" size="20"/></td>                              
                        </tr>                                                    
                      </tr> 
                     <tr>                                                   
                        <td class="desc_cell" nowrap><b><bean:message key ="risktranxperiodsetup.nooftransx"/></b></td>
                        <td valign="top"><html:text property="tranxNo" size="20"/></td>                                                           
                        </tr>                                                    
                     </tr>                                                                                   
                    </tbody>
