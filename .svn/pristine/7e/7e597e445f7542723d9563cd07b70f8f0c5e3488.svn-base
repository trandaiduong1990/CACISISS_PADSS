...
<body bgcolor="ffffff">
<html:form  action ="cardrenewalprocesslist">
...
<br><logic:present name="SEARCHLIST" scope="request"> 
  <display:table  id="cardRepProcess" name="requestScope.SEARCHLIST"  
   ...
   <display:column property="column2" title="CardNumber" class="label" />
   <display:column property="column3" title="Customer" class="label" />
   ...
   <display:caption><font class="titreSection">Card Renewal Records</font></display:caption>
   <font class="label"><display:column title="Details" align="center" width="80" ></font>
  	   <form name ="listForm" action="cardrenewalpage.do">	 
	 
              <html:hidden property="serialNo" value="<%= ((CommonDataBean)pageContext.getAttribute("cardRepProcess")).getColumn1()%>" />
              <html:hidden property="cardNumber" value="<%= ((CommonDataBean)pageContext.getAttribute("cardRepProcess")).getColumn2()%>" />
              <html:hidden property="issuerId" value="<%=(String)session.getAttribute("ISSUER")%>"/>
                 <html:hidden property="method" value ="renew"/>
