...
<script language="JavaScript">
    ...
    function addNew() {
       document.forms[0].action="delinquencyfeesetupprocess.do?method=addNew";
...
<html:form action ="delinquencyfeesetuplist.do">
  ...
  <tr>
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="titreSection"><bean:message key ="co.feeSearchTitle"/></td>
        </tr>
        <tr>
...
<br/>
    <display:table  id="commonObj" name="requestScope.SEARCHLIST" class="simple" width="70%">
	   	...
	   	<display:column property="column2" title="Age Begin Day" class="label" />
	   	<display:column property="column3" title="Age End Day" class="label" />
	   	<display:column property="column4" title="Updated Date" class="label" />
	   	<display:column property="column5" title="Updated By" class="label" />
	   	<font class="label"><display:column title="" align="center" width="80" >
			<form name ="listForm" action="delinquencyfeesetupprocess.do">
				<html:hidden property="id" value="<%= ((CommonDataBean)pageContext.getAttribute("commonObj")).getColumn6()%>" />       
