...
public class TransactionSummaryByDate implements ReportUtil {
	...
	public StringBuffer getReportFields() {
		...
		sbfStr.append("TO_CHAR(DATETIME, 'DD/MM/YYYY') AS TRAXDATE, COUNT (*) AS TOTAL, ");
	...
	public StringBuffer getFilterFields(Object obj) {
		...
		StringBuffer sbfStr = new StringBuffer();
		sbfStr.append("FROM TRANXLOG TL ");
		...
		sbfStr.append("GROUP BY TO_CHAR(DATETIME, 'DD/MM/YYYY') ");
		sbfStr.append("ORDER BY TO_CHAR(DATETIME, 'DD/MM/YYYY') ");
