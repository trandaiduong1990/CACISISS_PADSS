...
<html:html>
<head>
<title><bean:message key ="cardpromotionsetup.screentitile"/></title>
...
<script language="JavaScript">
   function go(action) {
    ...
    function showList(){
          document.forms[0].action= "cardpromotionlist.do?method=List";
          document.forms[0].submit();
       }
...
<body bgcolor="ffffff">
   <html:form action="cardpromotionprocess.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <tr> 
            <td class="titreSection" width="504"><bean:message key ="cardpromotionsetup.screentitile"/></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td class="form_tab_on" background="images/form_tab_bg_on.gif" style="padding-left:15px"> 
                         <bean:message key ="cardpromotionsetup.group1"/></td>
                  ...
                  <td class="form_bgcolor"  colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="padding: 20px 20px 10px 20px;" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="cardpromotionsetup.promotionid"/></b></td>
                          <td><html:text property="promotionId" maxlength="6" size="10"/></td>
                        </tr>
                        <tr>
                          <td class="desc_cell" nowrap><b><bean:message key ="cardpromotionsetup.promotiontype"/></b></td>
                          <td ><html:text property="promotionType" maxlength="30" size="35"/></td>
                        </tr>
                       </table></td>
                      </tr>
