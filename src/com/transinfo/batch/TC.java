...
public class TC {
	...
	public void unpackString(String st) throws Exception {
		Vector tmp = new Vector();
		field afield;
		for (Enumeration enmrt = fields.elements(); enmrt.hasMoreElements(); tmp
				.add(afield)) {
	...
	public void set(String fieldname, String content) throws Exception {
	...
	public String get(String fieldname) throws Exception {
		if (fieldname.equals("TCR"))
			fieldname = "TranxComponentSequenceNo";
		try {
			int idx = Integer.parseInt((String) indexTable.get(fieldname
					.toUpperCase()));
			if (idx >= 0) {
	...
	public void setARN(String FormatCode, String BIN, String TranxDate,
			String FilmLocator) {
