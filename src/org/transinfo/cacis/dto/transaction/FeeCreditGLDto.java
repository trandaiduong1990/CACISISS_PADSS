...
public class FeeCreditGLDto implements Serializable {
	
	private String feeCreditGLId;
	...
	public String getFeeCreditGLId() {
		return feeCreditGLId;
	}
	public void setFeeCreditGLId(String feeCreditGLId) {
		this.feeCreditGLId = feeCreditGLId;
	}
