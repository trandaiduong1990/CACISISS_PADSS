...
public class TransactionSummaryByCardNo implements ReportUtil {
	...
	public StringBuffer getReportFields() {
		...
		sbfStr.append("CARDNUMBER, COUNT (*) AS TOTAL, ");
	...
	public StringBuffer getFilterFields(Object obj) {
        ...
        if(!cardNo.trim().equals("")){
        	sbfStr.append("AND CARDNUMBER LIKE '"+ cardNo +"' ");
        }

		sbfStr.append("GROUP BY CARDNUMBER ");
		sbfStr.append("ORDER BY CARDNUMBER ");
