...
public class CardEmboss implements ReportUtil {

	private ResultSet resultset = null;

	private String userName = "";

	public Object setRequest(HttpServletRequest objRequest, HttpSession objSession) throws ReportException {
	...
	public StringBuffer getReportFields() {
		...
		sbfStr.append("CU.EMBOSSINGNAME AS EMBOSSNAME, C.EXPDATE AS EXPD, CP.CARDPRODUCTNAME AS CARDPRODUCTNAME ");
