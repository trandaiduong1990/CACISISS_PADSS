...
public class PinResendManager {

	private PinResendDAO objDAO;

	public PinResendManager() throws Exception {
		objDAO = DAOFactory.getInstance().getPinResendDAO();

	}

	public Collection search(String cardNo) throws TPlusException {

		Collection searchLst = null;

		try {
			searchLst = objDAO.search(cardNo);
	...
	public Collection cardCloseProcessSearch(CardCloseDto objDto, int pageNo)
		...
		try {
			...
			throw new TPlusException(
					"Error in CardReplacementProcessManager cardCloseProcessSearch method"
							+ e);
		}
		return searchLst;
	...
	public boolean pinResendAccept(PinResendDto objDto, String userId) throws TPlusException {
		boolean accept = false;
		try {
			accept = objDAO.pinResendAccept(objDto, userId);
		} catch (Exception e) {
			throw new TPlusException(
					"Error in PinResendManager pinResendAccept method" + e);
		}
		return accept;
	}
	...
	public boolean cardLimitAccept(CardLimitAdjustmentDto objDto)
			throws TPlusException {
		...
		try {
			 ...
			 * System.out.println("Record Not Exists"); }
			 */
			accept = objDAO.cardLimitAccept(objDto);
	...
	public CardsDto getCard(String cardNo) throws TPlusException {
		...
		try {
			objCardsDto = objDAO.getCard(cardNo);

		} catch (Exception e) {
			throw new TPlusException(
					"Error in PinResendManager getCard method:" + e);
		}
	...
	public PinResendDto getPinResendApp(String cardNo) throws TPlusException {
		...
		try {
			objPinResendDto = objDAO.getPinResendApp(cardNo);

		} catch (Exception e) {
			throw new TPlusException(
					"Error in PinResendManager getPinResendApp method:" + e);
		}
