...
public class CardEmbossingSearch extends ValidatorForm {
	...
	private String serialNosToEmboss = "";
	
	private String branchId;
	private String issuerId;

	public CardEmbossingSearch() {
		// getPreListData();
	}
	...
	public String getSerialNosToEmboss() {
		return serialNosToEmboss;
	}

	public void setSerialNosToEmboss(String serialNosToEmboss) {
		this.serialNosToEmboss = serialNosToEmboss;
	}
