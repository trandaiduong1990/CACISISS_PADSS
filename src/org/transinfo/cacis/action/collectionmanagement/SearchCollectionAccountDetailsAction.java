...
import org.transinfo.cacis.formbean.collectionmanagement.CollectionAccountDetailsSearchForm;
import org.transinfo.cacis.formbean.collectionmanagement.CollectionAccountDetailsSearchForm;
import org.transinfo.cacis.formbean.collectionmanagement.CollectionAccountDetailsSearchForm;
...
public class SearchCollectionAccountDetailsAction extends BaseAction {
	private Logger logger = Logger
			.getLogger(SearchCollectionAccountDetailsAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				CollectionAccountDetailsSearchForm objForm = (CollectionAccountDetailsSearchForm) form;
				CollectionAccountDetailsSearchForm newObjForm = new CollectionAccountDetailsSearchForm();
			...
			try {
				...
				objDto.setCurrentCollector(objForm.getAgentId());
			} catch (Exception e) {
				logger.error(e);
				System.out
			...
			Collection ageingActionList = objManager.search(objDto, objForm.getCustomerName(), pageNo);
