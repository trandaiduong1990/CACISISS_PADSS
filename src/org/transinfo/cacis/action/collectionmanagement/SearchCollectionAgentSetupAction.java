...
public class SearchCollectionAgentSetupAction extends BaseAction {
	private Logger logger = Logger
			.getLogger(SearchCollectionAgentSetupAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				CollectionAgentSearchForm objForm = (CollectionAgentSearchForm) form;
				CollectionAgentSearchForm newObjForm = new CollectionAgentSearchForm();
