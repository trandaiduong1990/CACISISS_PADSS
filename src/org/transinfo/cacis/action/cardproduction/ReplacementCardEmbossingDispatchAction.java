...
import org.transinfo.cacis.formbean.cardproduction.ReplacementCardEmbossingSearch;
...
public class ReplacementCardEmbossingDispatchAction extends BaseDispatchAction {
	
	private Logger logger = Logger.getLogger(ReplacementCardEmbossingDispatchAction.class);
	...
	public ActionForward save(ActionMapping mapping, ActionForm form,
		...
		// Form Validations
		ReplacementCardEmbossingSearch objForm = (ReplacementCardEmbossingSearch) form;
		/*
		...
		//String fileName = "CARD_EMB_REPLACEMENT" + dateTime + ".xls";
		// Action Execution
		...
		for (int i = 0; i < selectCardEmbossSerialNos.length; i++) {
			...
			try{
				...
				if(headerExecute){
					...
					String strFileName = "001_EM03"+pPrefix+"_REP_"+DateUtil.getStrDate("yyMMdd", embossDate)+"_"+DateUtil.getStrDate("HHmmss", embossDate)+".txt";
				...
				if(embossFile){
					//rowNumber++;
					boolean updateRes = objManager.updateObjectsReplacement(embossSerialNo, userId, embossDate);
					if(updateRes){
