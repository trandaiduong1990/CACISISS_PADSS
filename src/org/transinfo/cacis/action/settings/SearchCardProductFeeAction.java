...
import org.transinfo.cacis.formbean.settings.CardProductFeeSearchForm;

@SuppressWarnings({"deprecation" , "unchecked"})
public class SearchCardProductFeeAction extends BaseAction {

	private Logger logger = Logger.getLogger(SearchCardProductFeeAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if (request.getParameter("method") != null
			...
			try {
				...
				CardProductFeeSearchForm objForm = (CardProductFeeSearchForm) form;
				CardProductFeeSearchForm newObjForm = new CardProductFeeSearchForm();
			...
			// Dto Creation
			CardProductFeeSearchDto objDto = new CardProductFeeSearchDto();
			try {
				BeanUtils.copyProperties(objDto, objForm);
			} catch (Exception e) {
				logger.error(e);
				System.out
						.println("Error converting to form bean in SearchCardProductFeeAction execute method: "
								+ e.getMessage());
				throw new TPlusException(
						"Error converting to form bean in SearchCardProductFeeAction execute method: "
								+ e);
			}
			// Action Execution
