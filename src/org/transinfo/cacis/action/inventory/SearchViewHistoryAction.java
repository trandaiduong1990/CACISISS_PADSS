...
public class SearchViewHistoryAction extends BaseAction {
	private Logger logger = Logger
			.getLogger(SearchViewHistoryAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				ViewHistorySearchForm objForm = (ViewHistorySearchForm) form;
				ViewHistorySearchForm newObjForm = new ViewHistorySearchForm();
			...
			Collection orderList = objManager.seachHistory(objForm, pageNo);
