...
import org.transinfo.cacis.formbean.customerservice.TranxEnquiryNonReconTranxLogSearchForm;
...
public class TransactionEnquiryNonReconTranxLogSearchAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		if ((request.getParameter("method") != null)
			...
			try {
				...
				TranxEnquiryNonReconTranxLogSearchForm objForm = (TranxEnquiryNonReconTranxLogSearchForm) form;
				TranxEnquiryNonReconTranxLogSearchForm newObjForm = new TranxEnquiryNonReconTranxLogSearchForm();
			...
			// Dto Creation
			TranxEnquiryNonReconTranxlogSearchDto objDto = new TranxEnquiryNonReconTranxlogSearchDto();
			...
			try {
				...
				throw new TPlusException(
						"In TransactionEnquirySearchAction executeAction: " + e);
			}
	
			// Action execution
			TransactionEnquiryManager objTransactionEnquiryManager = new TransactionEnquiryManager();
			objDto = objTransactionEnquiryManager.searchNonReconTranx(objDto, pageNo);
