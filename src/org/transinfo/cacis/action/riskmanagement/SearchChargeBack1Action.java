...
import org.transinfo.cacis.controller.riskmanagement.ChargeBack1Manager;
...
public class SearchChargeBack1Action extends BaseDispatchAction {
	...
	public void commonSearch(int pageNo, OriginalRequestSearch objForm,
		...
		boolean exist = false;
		ActionErrors errors = null;
		ChargeBack1Manager objManager = new ChargeBack1Manager();
		...
		if (!exist) {
			...
			Collection ChargeBack1 = objManager.search(objDto, pageNo);
			request.setAttribute("SEARCHLIST", ChargeBack1);
		}
		request.setAttribute("PAGENO", new Integer(pageNo).toString());
		System.out.println("ChargeBack1Action: execute() successful");
	}
}